...
let e;
import { j as t, a as r } from "./lib--nodepkg-vue-jsx-runtime.BKjV4fr1.chunk.js";
import { _ as n, c as a, T as i, b as o, o as s, d as l, r as c, e as u, a as d, u as f, f as h, g as p, t as m, j as g, s as v, k as b, w as y, F as x } from "./lib--nodepkg-vuekit.DLZfr_ED.chunk.js";
...
function ei(e10) {
  var { from: t10 = 0, to: r10 = 1, restSpeed: a2 = 2, restDelta: i2 } = e10, o2 = n(e10, ["from", "to", "restSpeed", "restDelta"]);
  let s2 = { done: false, value: t10 }, { stiffness: l2, damping: c2, mass: u2, velocity: d2, duration: f2, isResolvedFromDuration: h2 } = function(e11) {
  ...
  function g2() {
    let e11 = d2 ? -(d2 / 1e3) : 0, n7 = r10 - t10, a3 = c2 / (2 * Math.sqrt(l2 * u2)), o3 = Math.sqrt(l2 / u2) / 1e3;
    if (void 0 === i2 && (i2 = Math.min(Math.abs(r10 - t10) / 100, 0.4)), a3 < 1) {
      let t11 = et(o3, a3);
      p2 = (i3) => r10 - Math.exp(-a3 * o3 * i3) * ((e11 + a3 * o3 * n7) / t11 * Math.sin(t11 * i3) + n7 * Math.cos(t11 * i3)), m2 = (r11) => {
        let i3 = Math.exp(-a3 * o3 * r11);
        return a3 * o3 * i3 * (Math.sin(t11 * r11) * (e11 + a3 * o3 * n7) / t11 + n7 * Math.cos(t11 * r11)) - i3 * (Math.cos(t11 * r11) * (e11 + a3 * o3 * n7) - t11 * n7 * Math.sin(t11 * r11));
      };
    } else if (1 === a3)
      p2 = (t11) => r10 - Math.exp(-o3 * t11) * (n7 + (e11 + o3 * n7) * t11);
    else {
      let t11 = o3 * Math.sqrt(a3 * a3 - 1);
      p2 = (i3) => {
        let s3 = Math.exp(-a3 * o3 * i3), l3 = Math.min(t11 * i3, 300);
        return r10 - s3 * ((e11 + a3 * o3 * n7) * Math.sinh(l3) + t11 * n7 * Math.cosh(l3)) / t11;
      };
    }
  }
  return g2(), { next: (e11) => {
    ...
    if (h2)
      ...
      let n7 = 1e3 * m2(e11), o3 = Math.abs(r10 - t11) <= i2;
      s2.done = Math.abs(n7) <= a2 && o3;
    }
    return s2.value = s2.done ? r10 : t11, s2;
  }, flipTarget: () => {
    d2 = -d2, [t10, r10] = [r10, t10], g2();
  } };
}
...
let eb = (e10, t10) => (r10) => !!(ep(r10) && eh.test(r10) && r10.startsWith(e10) || t10 && Object.prototype.hasOwnProperty.call(r10, t10)), ey = (e10, t10, r10) => (n7) => {
  if (!ep(n7))
    return n7;
  let [a2, i2, o2, s2] = n7.match(ed);
  ...
  return "hsla(" + Math.round(t10) + ", " + ev.transform(eu(r10)) + ", " + ev.transform(eu(n7)) + ", " + eu(eg.transform(a2)) + ")";
  ...
  return "rgba(" + ek.transform(t10) + ", " + ek.transform(r10) + ", " + ek.transform(n7) + ", " + eu(eg.transform(a2)) + ")";
...
function eO(e10) {
  ...
  let t10 = [], r10 = 0, n7 = e10.match(ef);
  n7 && (r10 = n7.length, e10 = e10.replace(ef, e_), t10.push(...n7.map(eP.parse)));
  let a2 = e10.match(ed);
  return a2 && (e10 = e10.replace(ed, eS), t10.push(...a2.map(em.parse))), { values: t10, numColors: r10, tokenised: e10 };
}
let eD = function(e10) {
  let { values: t10, numColors: r10, tokenised: n7 } = eO(e10), a2 = t10.length;
  return (e11) => {
    let t11 = n7;
    for (let n9 = 0; n9 < a2; n9++)
      t11 = t11.replace(n9 < r10 ? e_ : eS, n9 < r10 ? eP.transform(e11[n9]) : eu(e11[n9]));
    return t11;
  };
};
...
let eR = (e10, t10, r10) => {
  ...
  let r10 = eI(e10), n7 = eI(t10), a2 = r10.parse(e10), i2 = n7.parse(t10);
  r10 === ex && (a2 = e$(a2), r10 = eM), n7 === ex && (i2 = e$(i2), n7 = eM);
...
let eE = (e10, t10) => {
  let r10 = [...e10], n7 = r10.length, a2 = e10.map((e11, r11) => eV(e11, t10[r11]));
  return (e11) => {
  ...
  for (let a2 in r10)
    void 0 !== e10[a2] && void 0 !== t10[a2] && (n7[a2] = eV(e10[a2], t10[a2]));
  return (e11) => {
    for (let t11 in n7)
      r10[t11] = n7[t11](e11);
    return r10;
...
function ez(e10) {
  let t10 = eO(e10).values, r10 = t10.length, n7 = 0, a2 = 0, i2 = 0;
  for (let e11 = 0; e11 < r10; e11++)
    n7 || "number" == typeof t10[e11] ? n7++ : void 0 !== t10[e11].hue ? i2++ : a2++;
  return { parsed: t10, numNumbers: n7, numRGB: a2, numHSL: i2 };
}
let eW = (e10, t10) => {
  let r10 = eD(t10), n7 = ez(e10), a2 = ez(t10);
  return n7.numHSL === a2.numHSL && n7.numRGB === a2.numRGB && n7.numNumbers >= a2.numNumbers ? ej(eE(n7.parsed, a2.parsed), r10) : (r11) => `${r11 > 0 ? t10 : e10}`;
...
function eq(e10, t10) {
  ...
  Q(i2 === t10.length), Q(!n7 || !Array.isArray(n7) || n7.length === i2 - 1), e10[0] > e10[i2 - 1] && (e10 = [].concat(e10), t10 = [].concat(t10), e10.reverse(), t10.reverse());
  let o2 = function(e11, t11, r11) {
    var n9;
    let a3 = [], i3 = r11 || ("number" == typeof (n9 = e11[0]) ? eN : "string" == typeof n9 ? eP.test(n9) ? eL : eW : Array.isArray(n9) ? eE : "object" == typeof n9 ? eH : void 0), o3 = e11.length - 1;
    for (let r12 = 0; r12 < o3; r12++) {
      let n10 = i3(e11[r12], e11[r12 + 1]);
      t11 && (n10 = ej(Array.isArray(t11) ? t11[r12] : t11, n10)), a3.push(n10);
    }
    return a3;
  }(t10, n7, a2), s2 = 2 === i2 ? function(e11, t11) {
    let [r11, n9] = e11, [a3] = t11;
    return (e12) => a3(es(r11, n9, e12));
...
function eY(e10) {
  ...
  function c2() {
    return eq(l2, s2, { ease: Array.isArray(n7) ? n7 : s2.map(() => n7 || eG).splice(0, s2.length - 1) });
  }
  let u2 = c2();
...
let eX = { keyframes: eY, spring: ei, decay: function(e10) {
  ...
  let t11 = [], r10 = [], n7 = 0, a2 = false, i2 = false, o2 = /* @__PURE__ */ new WeakSet(), s2 = { schedule: function(e12) {
    ...
    if (a2 = true, [t11, r10] = [r10, t11], r10.length = 0, n7 = t11.length)
      for (let r11 = 0; r11 < n7; r11++) {
        let n9 = t11[r11];
  ...
  return e10[t10] = function(e11) {
    ...
    return e0 || e7(), r10.schedule(e11, t11, n7);
  }, e10;
...
function tr(e10) {
  let t10, r10, a2;
  var i2, { from: o2, autoplay: s2 = true, driver: l2 = tt, elapsed: c2 = 0, repeat: u2 = 0, repeatType: d2 = "loop", repeatDelay: f2 = 0, onPlay: h2, onStop: p2, onComplete: m2, onRepeat: g2, onUpdate: v2 } = e10, b2 = n(e10, ["from", "autoplay", "driver", "elapsed", "repeat", "repeatType", "repeatDelay", "onPlay", "onStop", "onComplete", "onRepeat", "onUpdate"]);
  ...
  return s2 && (null == h2 || h2(), (t10 = l2(function(e11) {
    if (M2 || (e11 = -e11), c2 += e11, !k2) {
      let e12 = P2.next(Math.max(0, c2));
      r10 = e12.value, a2 && (r10 = a2(r10)), k2 = M2 ? e12.done : c2 <= 0;
    }
    if (null == v2 || v2(r10), k2) {
      if (0 === x2 && (null != w2 || (w2 = c2)), x2 < u2) {
        var n7, i3;
        n7 = c2, i3 = w2, (M2 ? n7 >= i3 + f2 : n7 <= -f2) && (x2++, "reverse" === d2 ? c2 = function(e12, t11) {
  ...
  switch (typeof r10) {
    ...
    case "object":
      ...
      if (void 0 !== r10.styles) {
        ...
        if (void 0 !== n7)
          for (; void 0 !== n7; )
            J = { name: n7.name, styles: n7.styles, next: J }, n7 = n7.next;
        return r10.styles + ";";
      }
      return function(e11, t11, r11) {
        ...
        if (Array.isArray(r11))
          for (var a3 = 0; a3 < r11.length; a3++)
            n9 += tm(e11, t11, r11[a3]) + ";";
        else
          for (var i3 in r11) {
            var o3 = r11[i3];
            if ("object" != typeof o3)
              null != t11 && void 0 !== t11[o3] ? n9 += i3 + "{" + t11[o3] + "}" : tf(o3) && (n9 += th(i3) + ":" + tp(i3, o3) + ";");
            else if (Array.isArray(o3) && "string" == typeof o3[0] && (null == t11 || void 0 === t11[o3[0]]))
              for (var s2 = 0; s2 < o3.length; s2++)
                tf(o3[s2]) && (n9 += th(i3) + ":" + tp(i3, o3[s2]) + ";");
            else {
...
var tg = /label:\s*([^\s;\n{]+)\s*(;|$)/g, tv = function(e10, t10, r10) {
  ...
  tg.lastIndex = 0;
  for (var l2 = ""; null !== (n7 = tg.exec(i2)); )
    l2 += "-" + n7[1];
  return { name: function(e11) {
    for (var t11, r11 = 0, n9 = 0, a3 = e11.length; a3 >= 4; ++n9, a3 -= 4)
      t11 = (65535 & (t11 = 255 & e11.charCodeAt(n9) | (255 & e11.charCodeAt(++n9)) << 8 | (255 & e11.charCodeAt(++n9)) << 16 | (255 & e11.charCodeAt(++n9)) << 24)) * 1540483477 + ((t11 >>> 16) * 59797 << 16), t11 ^= t11 >>> 24, r11 = (65535 & t11) * 1540483477 + ((t11 >>> 16) * 59797 << 16) ^ (65535 & r11) * 1540483477 + ((r11 >>> 16) * 59797 << 16);
    switch (a3) {
      case 3:
        r11 ^= (255 & e11.charCodeAt(n9 + 2)) << 16;
      case 2:
        r11 ^= (255 & e11.charCodeAt(n9 + 1)) << 8;
      case 1:
        r11 ^= 255 & e11.charCodeAt(n9), r11 = (65535 & r11) * 1540483477 + ((r11 >>> 16) * 59797 << 16);
    }
...
const _t_ = class _t_ {
  ...
  processAll(e10) {
    ...
    if (n7) {
      let e11 = {}, t11 = {};
      _t_.walkStateValues(n7, (r11, n9, a3) => {
        var i3;
        let o2 = `--${this.opt.varPrefix}-state-${n9.join("-")}`, s2 = null !== (i3 = C(n9)) && void 0 !== i3 ? i3 : "", l2 = {};
  ...
  processTo(e10, t10) {
    ...
    for (let n7 in t10)
      this.process(e10, n7, t10[n7], r10);
  }
  process(e10, t10, r10) {
    var n7, a2, i2, o2;
...
__publicField(_t_, "convertSelector", (e10) => {
  ...
  if (t10.startsWith("$") || t10.endsWith("$") || t10.startsWith("_")) {
    ...
    if (t10.startsWith("_") ? (e11 = "&", t10 = t10.slice(1)) : t10.startsWith("$") ? (e11 = "& ", t10 = t10.slice(1)) : (r10 = " &", t10 = t10.slice(0, t10.length - 1)), t10.startsWith("data") || t10.startsWith("aria")) {
      ...
      return a2 ? `${e11}[${w(n7)}='${w(a2)}']${r10}` : `${e11}[${w(n7)}]${r10}`;
    }
    if ("&" === e11) {
      if (t10.startsWith("$"))
      ...
      let [r11, n7] = t10.split("__"), a2 = w(r11);
      return n7 ? `${e11}[data-${a2}='${w(n7)}']` : `${e11}[data-${a2}]:not([data-${a2}='false'])`;
    }
  }
});
__publicField(_t_, "walkStateValues", function(e10, t10) {
  ...
  for (let e11 in a2) {
    var i2;
    let o2 = a2[e11], s2 = null !== (i2 = a2.default) && void 0 !== i2 ? i2 : r10.default, l2 = null != n7 ? n7 : k(s2, [...r10.path.slice(1), "$"]), c2 = l2 ? [...r10.selectorPath, l2] : r10.selectorPath, u2 = [...r10.path, e11];
    if (M(o2)) {
...
const _tT = class _tT {
  constructor(e10, { cssVar: t10, transformFallback: r10 }) {
    ...
    _tT.walkValues(e10.value, (n7, a2) => {
      ...
      if (P(this._cssVarRefs, [i2], t10(i2)), M(n7))
        for (let e11 in n7)
          o2(n7[e11], (t11, r11) => {
...
const _tj = class _tj {
  constructor(e10, t10 = {}) {
    ...
    var r10, n7;
    for (let a2 in this.theme = e10, this.varPrefix = null !== (r10 = t10.varPrefix) && void 0 !== r10 ? r10 : "vk", this.mode = null !== (n7 = t10.mode) && void 0 !== n7 ? n7 : "light", P(this.cssVars, [this.cssVar("space", "dp")], "0.1rem"), e10) {
      let t11 = e10[a2];
      if (t11) {
        if (t11.type === tS.var) {
          ...
          for (let t12 of e11.tokens)
            for (let r11 of ["light", "dark"]) {
              ...
              F(i2) || ("_default" === n9 ? P(this.cssVars, [this.cssVar(a2, t12)], i2) : P(this.cssVars, [n9, this.cssVar(a2, t12)], i2));
            }
          continue;
        }
  ...
  unstable_css(e10, t10) {
    var r10;
    let n7 = null != t10 ? t10 : {};
    return n7.__emotion_styles = null !== (r10 = n7.__emotion_styles) && void 0 !== r10 ? r10 : tv(this.unstable_sx(t10), null == e10 ? void 0 : e10.registered, {}), n7.__emotion_styles;
  }
  toFigmaTokens() {
    let e10 = { space: { dp: { $type: "sizing", $value: 1 } } }, t10 = {}, r10 = {}, n7 = (e11, t11) => T(t11) ? { $type: e11, $value: R(t11, (t12) => n7(e11, t12).$value) } : S(t11) ? { $type: e11, $value: t11.replace(/var\(([^)]+)\)/g, (e12) => {
      var t12, r11;
      let n9 = null !== (r11 = null === (t12 = e12.slice(4, e12.length - 1).slice(`--${this.varPrefix}-`.length).split("--")[0]) || void 0 === t12 ? void 0 : t12.split("__").map((e13, t13) => 0 === t13 ? j(e13) : e13).join(".")) && void 0 !== r11 ? r11 : "";
        ...
        for (let s2 of i2.tokens)
          if (!s2.includes("/")) {
            if (s2.startsWith("sys.")) {
              ...
              tD(e10, [a2, ...s2.split(".")], n7(o3, i2.get(s2, "_default")));
          }
      };
      switch (a2) {
        case "color":
...
let tV = { shadow: tO.shadow({ 0: { _default: "0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px 0px rgba(0, 0, 0, 0)", _dark: "0px 0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px rgba(0, 0, 0, 0)" }, 1: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 1px 3px 1px rgba(0, 0, 0, 0.15)", _dark: "0px 1px 3px 1px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 2: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 2px 6px 2px rgba(0, 0, 0, 0.15)", _dark: "0px 2px 6px 2px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 3: { _default: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)" }, 4: { _default: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)" }, 5: { _default: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)", _dark: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)" } }), elevation: tO.customMixin("elevation", { 0: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "0", _hover: { shadow: "1" } }), 1: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "1", _hover: { shadow: "2" } }), 2: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "2", _hover: { shadow: "3" } }), 3: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "3", _hover: { shadow: "4" } }), 4: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "4", _hover: { shadow: "5" } }) }) }, tE = (e10, t10, r10, n7) => Object.assign(function(e11, t11, r11, n9) {
  ...
  return (i2) => 0 === i2 || 1 === i2 ? i2 : to(function(t12) {
    ...
    for (; 10 !== i3 && a2[i3] <= t12; ++i3)
      n10 += 0.1;
    let o2 = n10 + (t12 - a2[--i3]) / (a2[i3 + 1] - a2[i3]) * 0.1, s2 = ts(o2, e11, r11);
    return s2 >= 1e-3 ? function(e12, t13, r12, n11) {
      for (let a3 = 0; a3 < 8; ++a3) {
        let a4 = ts(t13, r12, n11);
        if (0 === a4)
          break;
        let i4 = to(t13, r12, n11) - e12;
        t13 -= i4 / a4;
      }
      return t13;
      ...
      let s3 = 0;
      do
        (i4 = to(o3 = t13 + (r12 - t13) / 2, n11, a3) - e12) > 0 ? r12 = o3 : t13 = o3;
  ...
  let n7 = null != r10 ? r10 : { ...e10, from: { ...e10.to }, to: { ...e10.from } };
  return a({ onComplete: V(), $default: V() }, (r11, a2) => {
    let o2, { slots: s2, emit: l2 } = a2, c2 = (t10, r12) => {
      o2 = tr({ ...e10, autoplay: true, onComplete: () => {
        r12(), l2("complete", "enter");
      }, onUpdate: (e11) => {
        Object.assign(t10.style, e11);
      } });
    }, u2 = (e11, t10) => {
      o2 = tr({ ...n7, autoplay: true, onComplete: () => {
    ...
    return () => {
      var e11;
      return t(i, { css: false, onEnter: c2, onEnterCancelled: d2, onLeave: u2, onLeaveCancelled: d2, children: null === (e11 = s2.default) || void 0 === e11 ? void 0 : e11.call(s2) });
    };
  }, { name: "Transition" });
...
class t3 {
  ...
  static fromXyzInViewingConditions(e10, t10, r10, n7) {
    let a2 = n7.rgbD[0] * (0.401288 * e10 + 0.650173 * t10 - 0.051461 * r10), i2 = n7.rgbD[1] * (-0.250268 * e10 + 1.204414 * t10 + 0.045854 * r10), o2 = n7.rgbD[2] * (-2079e-6 * e10 + 0.048952 * t10 + 0.953127 * r10), s2 = Math.pow(n7.fl * Math.abs(a2) / 100, 0.42), l2 = Math.pow(n7.fl * Math.abs(i2) / 100, 0.42), c2 = Math.pow(n7.fl * Math.abs(o2) / 100, 0.42), u2 = 400 * tN(a2) * s2 / (s2 + 27.13), d2 = 400 * tN(i2) * l2 / (l2 + 27.13), f2 = 400 * tN(o2) * c2 / (c2 + 27.13), h2 = (11 * u2 + -12 * d2 + f2) / 11, p2 = (u2 + d2 - 2 * f2) / 9, m2 = 180 * Math.atan2(p2, h2) / Math.PI, g2 = m2 < 0 ? m2 + 360 : m2 >= 360 ? m2 - 360 : m2, v2 = g2 * Math.PI / 180, b2 = 100 * Math.pow((40 * u2 + 20 * d2 + f2) / 20 * n7.nbb / n7.aw, n7.c * n7.z), y2 = 4 / n7.c * Math.sqrt(b2 / 100) * (n7.aw + 4) * n7.fLRoot, x2 = Math.pow(5e4 / 13 * (0.25 * (Math.cos((g2 < 20.14 ? g2 + 360 : g2) * Math.PI / 180 + 2) + 3.8)) * n7.nc * n7.ncb * Math.sqrt(h2 * h2 + p2 * p2) / ((20 * u2 + 20 * d2 + 21 * f2) / 20 + 0.305), 0.9) * Math.pow(1.64 - Math.pow(0.29, n7.n), 0.73), w2 = x2 * Math.sqrt(b2 / 100), k2 = w2 * n7.fLRoot, M2 = 50 * Math.sqrt(x2 * n7.c / (n7.aw + 4)), C2 = Math.log(1 + 0.0228 * k2) / 0.0228;
...
class t8 {
  ...
  static hueOf(e10) {
    let t10 = tU(e10, t8.SCALED_DISCOUNT_FROM_LINRGB), r10 = t8.chromaticAdaptation(t10[0]), n7 = t8.chromaticAdaptation(t10[1]), a2 = t8.chromaticAdaptation(t10[2]);
  ...
  static setCoordinate(e10, t10, r10, n7) {
    let a2 = t8.intercept(e10[n7], t10, r10[n7]);
  ...
  static nthVertex(e10, t10) {
    let r10 = t8.Y_FROM_LINRGB[0], n7 = t8.Y_FROM_LINRGB[1], a2 = t8.Y_FROM_LINRGB[2], i2 = t10 % 4 <= 1 ? 0 : 100, o2 = t10 % 2 == 0 ? 0 : 100;
    if (t10 < 4) {
  ...
  static bisectToSegment(e10, t10) {
    ...
    for (let l2 = 0; l2 < 12; l2++) {
      ...
      (s2 || t8.areInCyclicOrder(a2, u2, i2)) && (s2 = false, t8.areInCyclicOrder(a2, t10, u2) ? (n7 = c2, i2 = u2) : (r10 = c2, a2 = u2));
    }
    return [r10, n7];
  }
  ...
  static bisectToLimit(e10, t10) {
    let r10 = t8.bisectToSegment(e10, t10), n7 = r10[0], a2 = t8.hueOf(n7), i2 = r10[1];
    for (let e11 = 0; e11 < 3; e11++)
      if (n7[e11] !== i2[e11]) {
        let r11 = -1, o2 = 255;
        n7[e11] < i2[e11] ? (r11 = t8.criticalPlaneBelow(t8.trueDelinearized(n7[e11])), o2 = t8.criticalPlaneAbove(t8.trueDelinearized(i2[e11]))) : (r11 = t8.criticalPlaneAbove(t8.trueDelinearized(n7[e11])), o2 = t8.criticalPlaneBelow(t8.trueDelinearized(i2[e11])));
        for (let s2 = 0; s2 < 8 && !(1 >= Math.abs(o2 - r11)); s2++) {
          let s3 = Math.floor((r11 + o2) / 2), l2 = t8.CRITICAL_PLANES[s3], c2 = t8.setCoordinate(n7, l2, i2, e11), u2 = t8.hueOf(c2);
          t8.areInCyclicOrder(a2, t10, u2) ? (i2 = c2, o2 = s3) : (n7 = c2, a2 = u2, r11 = s3);
        }
      }
    return t8.midpoint(n7, i2);
  }
  ...
  static findResultByJ(e10, t10, r10) {
    let n7 = 11 * Math.sqrt(r10), a2 = t5.DEFAULT, i2 = 1 / Math.pow(1.64 - Math.pow(0.29, a2.n), 0.73), o2 = 5e4 / 13 * (0.25 * (Math.cos(e10 + 2) + 3.8)) * a2.nc * a2.ncb, s2 = Math.sin(e10), l2 = Math.cos(e10);
  ...
  static solveToInt(e10, t10, r10) {
    ...
    (n7 = e10 % 360) < 0 && (n7 += 360);
    let a2 = (e10 = n7) / 180 * Math.PI, i2 = tQ(r10), o2 = t8.findResultByJ(a2, t10, i2);
...
class t9 {
  ...
  static lighter(e10, t10) {
    if (e10 < 0 || e10 > 100)
      return -1;
    let r10 = tQ(e10), n7 = t10 * (r10 + 5) - 5, a2 = t9.ratioOfYs(n7, r10);
  ...
  static darker(e10, t10) {
    if (e10 < 0 || e10 > 100)
      return -1;
    let r10 = tQ(e10), n7 = (r10 + 5) / t10 - 5, a2 = t9.ratioOfYs(r10, n7);
    if (a2 < t10 && Math.abs(a2 - t10) > 0.04)
      return -1;
    let i2 = t0(n7) - 0.4;
    return i2 < 0 || i2 > 100 ? -1 : i2;
...
class re {
  ...
  constructor(e10, t10, r10, n7, a2, i2, o2, s2) {
    if (this.name = e10, this.palette = t10, this.tone = r10, this.isBackground = n7, this.background = a2, this.secondBackground = i2, this.contrastCurve = o2, this.toneDeltaPair = s2, this.hctCache = /* @__PURE__ */ new Map(), !a2 && i2)
  ...
  getTone(e10) {
    ...
    if (this.toneDeltaPair) {
      let r10 = this.toneDeltaPair(e10), n7 = r10.roleA, a2 = r10.roleB, i2 = r10.delta, o2 = r10.polarity, s2 = r10.stayTogether, l2 = this.background(e10).getTone(e10), c2 = "nearer" === o2 || "lighter" === o2 && !e10.isDark || "darker" === o2 && e10.isDark, u2 = c2 ? n7 : a2, d2 = c2 ? a2 : n7, f2 = this.name === u2.name, h2 = e10.isDark ? 1 : -1, p2 = u2.contrastCurve.getContrast(e10.contrastLevel), m2 = d2.contrastCurve.getContrast(e10.contrastLevel), g2 = u2.tone(e10), v2 = t9.ratioOfTones(l2, g2) >= p2 ? g2 : re.foregroundTone(l2, p2), b2 = d2.tone(e10), y2 = t9.ratioOfTones(l2, b2) >= m2 ? b2 : re.foregroundTone(l2, m2);
    ...
    }
    {
      ...
      if (t9.ratioOfTones(n7, r10) >= a2 || (r10 = re.foregroundTone(n7, a2)), t10 && (r10 = re.foregroundTone(n7, a2)), this.isBackground && 50 <= r10 && r10 < 60 && (r10 = t9.ratioOfTones(49, n7) >= a2 ? 49 : 60), this.secondBackground) {
  ...
  static foregroundTone(e10, t10) {
    let r10 = t9.lighterUnsafe(e10, t10), n7 = t9.darkerUnsafe(e10, t10), a2 = t9.ratioOfTones(r10, e10), i2 = t9.ratioOfTones(n7, e10);
    if (!re.tonePrefersLightForeground(e10))
      return i2 >= t10 || i2 >= a2 ? n7 : r10;
    {
...
class rs {
  ...
  static createKeyColor(e10, t10) {
    let r10 = t6.from(e10, t10, 50), n7 = Math.abs(r10.chroma - t10);
...
class rl {
  ...
  static createPaletteFromColors(e10, t10) {
    ...
    if (t10.secondary) {
      let n7 = new rl(t10.secondary, e10);
      r10.a2 = n7.a1;
    }
    if (t10.tertiary) {
      let n7 = new rl(t10.tertiary, e10);
      r10.a3 = n7.a1;
    }
    if (t10.error) {
      let n7 = new rl(t10.error, e10);
      r10.error = n7.a1;
    }
    if (t10.neutral) {
      let n7 = new rl(t10.neutral, e10);
      r10.n1 = n7.n1;
    }
    if (t10.neutralVariant) {
      let n7 = new rl(t10.neutralVariant, e10);
      r10.n2 = n7.n2;
    }
    return r10;
  }
  constructor(e10, t10) {
    let r10 = t6.fromInt(e10), n7 = r10.hue, a2 = r10.chroma;
    t10 ? (this.a1 = rs.fromHueAndChroma(n7, a2), this.a2 = rs.fromHueAndChroma(n7, a2 / 3), this.a3 = rs.fromHueAndChroma(n7 + 60, a2 / 2), this.n1 = rs.fromHueAndChroma(n7, Math.min(a2 / 12, 4)), this.n2 = rs.fromHueAndChroma(n7, Math.min(a2 / 6, 8))) : (this.a1 = rs.fromHueAndChroma(n7, Math.max(48, a2)), this.a2 = rs.fromHueAndChroma(n7, 16), this.a3 = rs.fromHueAndChroma(n7 + 60, 24), this.n1 = rs.fromHueAndChroma(n7, 4), this.n2 = rs.fromHueAndChroma(n7, 8)), this.error = rs.fromHueAndChroma(25, 84);
  }
}
function rc(e10) {
  ...
  let a2 = 0, i2 = 0, o2 = 0;
  return t10 ? (a2 = ru(e10.slice(0, 1).repeat(2)), i2 = ru(e10.slice(1, 2).repeat(2)), o2 = ru(e10.slice(2, 3).repeat(2))) : r10 ? (a2 = ru(e10.slice(0, 2)), i2 = ru(e10.slice(2, 4)), o2 = ru(e10.slice(4, 6))) : n7 && (a2 = ru(e10.slice(2, 4)), i2 = ru(e10.slice(4, 6)), o2 = ru(e10.slice(6, 8))), (-16777216 | (255 & a2) << 16 | (255 & i2) << 8 | 255 & o2) >>> 0;
}
function ru(e10) {
...
const _rp = class _rp {
  ...
  getThemeRoleColors(e10) {
    ...
    for (let i2 in e10) {
      ...
      if (this.seeds[o2]) {
        var n7, a2;
        r10[i2] = rd[s2] ? `${o2}.${s2}` : null === (n7 = this.seeds[o2]) || void 0 === n7 ? void 0 : n7.tone(s2), t10[i2] = rd[l2] ? `${o2}.${l2}` : null === (a2 = this.seeds[o2]) || void 0 === a2 ? void 0 : a2.tone(l2);
      }
    }
    return [t10, r10];
  }
  toDesignTokens() {
    let e10 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, [t10, r10] = this.getThemeRoleColors(this.normalizeRoleRules(e10)), n7 = {}, a2 = {};
    for (let e11 in t10)
      if (n7[`${e11}`] = { _default: B(t10[e11]) ? rf(t10[e11]) : t10[e11], _dark: B(r10[e11]) ? rf(r10[e11]) : r10[e11] }, rh(e11) && (a2[`${e11}`] = tO.mixin({ bgColor: `sys.${e11}`, color: `sys.on-${e11}` }), a2[`${e11}-container`] = tO.mixin({ bgColor: `sys.${e11}-container`, color: `sys.on-${e11}-container` })), e11.startsWith("surface")) {
    ...
    return { color: tO.color({ ...R(this.seeds, (e11) => i2(e11)), white: [255, 255, 255], black: [0, 0, 0], sys: n7 }), containerStyle: tO.customMixin("containerStyle", { sys: a2 }) };
  }
};
__publicField(_rp, "toHEX", (e10) => `#${rf(e10).map((e11) => E(e11.toString(16), 2, "0")).join("")}`);
__publicField(_rp, "fromColors", (e10) => {
  let { primary: t10, secondary: r10, tertiary: n7, neutral: a2, neutralVariant: i2, error: o2, ...s2 } = e10, l2 = rl.contentFromColors({ primary: rc(t10), secondary: r10 ? rc(r10) : void 0, tertiary: n7 ? rc(n7) : void 0, error: o2 ? rc(o2) : void 0 });
...
function rN(e10, t10, r10, n7, a2, i2, o2) {
  return { value: e10, root: t10, parent: r10, type: n7, props: a2, children: i2, line: rj, column: rV, length: o2, return: "" };
}
function rq(e10, t10) {
...
function rJ(e10, t10, r10, n7, a2, i2, o2, s2, l2, c2, u2) {
  for (var d2 = a2 - 1, f2 = 0 === a2 ? i2 : [""], h2 = f2.length, p2 = 0, m2 = 0, g2 = 0; p2 < n7; ++p2)
...
function rZ(e10, t10, r10, n7) {
  return rN(e10, t10, r10, rS, rL(e10, 0, n7), rL(e10, n7 + 1, -1), n7);
}
function rQ(e10, t10) {
  for (var r10 = "", n7 = e10.length, a2 = 0; a2 < n7; a2++)
    r10 += t10(e10[a2], a2, e10, t10) || "";
  return r10;
}
function r0(e10, t10, r10, n7) {
  switch (e10.type) {
    case "@layer":
    ...
    case rP:
      return "";
    case rO:
      return e10.return = e10.value + "{" + rQ(e10.children, n7) + "}";
    case r_:
      e10.value = e10.props.join(",");
  }
  return rF(r10 = rQ(e10.children, n7)) ? e10.return = e10.value + "{" + r10 + "}" : "";
}
var r1 = function(e10, t10, r10) {
  for (var n7 = 0, a2 = 0; n7 = a2, a2 = rG(), 38 === n7 && 12 === a2 && (t10[r10] = 1), !rY(a2); )
    rU();
  return rL(rW, e10, rH);
}, r2 = function(e10, t10) {
  var r10 = -1, n7 = 44;
  do
    switch (rY(n7)) {
      case 0:
        38 === n7 && 12 === rG() && (t10[r10] = 1), e10[r10] += r1(rH - 1, t10, r10);
        break;
      case 2:
        e10[r10] += rK(n7);
        break;
  ...
  if ("rule" === e10.type && e10.parent && !(e10.length < 1)) {
    for (var t10 = e10.value, r10 = e10.parent, n7 = e10.column === r10.column && e10.line === r10.line; "rule" !== r10.type; )
      if (!(r10 = r10.parent))
        return;
    if ((1 !== e10.props.length || 58 === t10.charCodeAt(0) || r5.get(r10)) && !n7) {
      r5.set(e10, true);
  ...
  if (e10.length > -1 && !e10.return)
    switch (e10.type) {
      case rS:
        ...
        break;
      case rO:
        return rQ([rq(e10, { value: rR(e10.value, "@", "@" + rC) })], n7);
      case r_:
        if (e10.length) {
          var a2, i2;
          return a2 = e10.props, i2 = function(t11) {
            ...
            switch (r11 = t11, (r11 = /(::plac\w+|:read-\w+)/.exec(r11)) ? r11[0] : r11) {
              case ":read-only":
              case ":read-write":
                return rQ([rq(e10, { props: [rR(t11, /:(read-\w+)/, ":" + rM + "$1")] })], n7);
              case "::placeholder":
                return rQ([rq(e10, { props: [rR(t11, /:(plac\w+)/, ":" + rC + "input-$1")] }), rq(e10, { props: [rR(t11, /:(plac\w+)/, ":" + rM + "$1")] }), rq(e10, { props: [rR(t11, /:(plac\w+)/, rk + "input-$1")] })], n7);
            }
            return "";
          }, a2.map(i2).join("");
        }
  ...
  var f2 = (r10 = (t10 = [r3, r8].concat(c2, [r0, (n7 = function(e11) {
    o2.insert(e11);
  }, function(e11) {
    !e11.root && (e11 = e11.return) && n7(e11);
  })])).length, function(e11, n9, a3, i3) {
    for (var o3 = "", s3 = 0; s3 < r10; s3++)
      o3 += t10[s3](e11, n9, a3, i3) || "";
    return o3;
  }), h2 = function(e11) {
    var t11, r11;
    return rQ((r11 = function e12(t12, r12, n9, a3, i3, o3, s3, l3, c3) {
          ...
          case 47:
            switch (rG()) {
              ...
              case 47:
                ...
                }(rU(), rH), r12, n9, rP, rT(rz), rL(u3, 2, -2), 0), c3);
                break;
              default:
                P2 += "/";
            }
          ...
          case 0:
            switch (x2) {
              ...
              case 125:
                b2 = 0;
              case 59 + f3:
                -1 == y2 && (P2 = rR(P2, /\f/g, "")), m2 > 0 && rF(P2) - h3 && rB(m2 > 32 ? rZ(P2 + ";", a3, n9, h3 - 1) : rZ(rR(P2, " ", "") + ";", a3, n9, h3 - 2), c3);
                break;
              case 59:
                P2 += ";";
              default:
                if (rB(C2 = rJ(P2, r12, n9, d3, f3, i3, l3, w2, k2 = [], M2 = [], h3), o3), 123 === x2) {
                  if (0 === f3)
...
let nt = o(() => r9({ key: "css" }), { name: "Cache" }), nr = (e10) => (t10) => {
  if (t10.serialized) {
...
}, nn = Object.assign(a({ sx: V(), component: V().optional().default("div") }, (e10, r10) => {
  var n7;
  let { slots: a2, expose: i2 } = r10, o2 = rx.use(), c2 = nt.use(), u2 = o2.unstable_css(c2, null !== (n7 = e10.sx) && void 0 !== n7 ? n7 : {}), d2 = () => "0" !== u2.name ? `${c2.key}-${u2.name}` : "", f2 = nr(c2);
  s(() => {
  ...
  return i2({ $$forwardRef: h2 }), () => {
    var r11;
    return t(null !== (r11 = e10.component) && void 0 !== r11 ? r11 : "div", { ref: h2, class: d2(), children: a2 });
  };
...
function ni(e10, t10, r10) {
  var n7;
  let i2 = null !== (n7 = L(t10) ? t10 : r10) && void 0 !== n7 ? n7 : na, o2 = M(t10) ? t10 : {};
  return (t11) => {
    let r11 = a({ ...o2, sx: V().optional(), component: V().optional() }, (n9, a2) => {
      let o3 = rx.use(), l2 = nt.use(), f2 = nr(l2);
      t11.label = r11.name;
      let h2 = c(""), p2 = o3.unstable_css(l2, t11), m2 = () => "0" !== p2.name ? `${l2.key}-${p2.name}${h2.value}` : `${h2.value}`;
      if (e10.__styled) {
        var g2;
        let e11 = o3.unstable_css(l2, null !== (g2 = n9.sx) && void 0 !== g2 ? g2 : {});
        "0" !== e11.name && (h2.value = ` ${l2.key}-${e11.name}`), s(() => {
      ...
      return () => {
        if (e10.__styled) {
          let t13 = v2(e10);
          return t13 ? d(t13, { component: n9.component, class: m2() }) : null;
        }
        let t12 = v2(nn);
        return t12 ? d(t12, { component: n9.component || e10, sx: n9.sx, class: m2() }) : null;
      };
    });
    return r11.__styled = true, r11;
  };
}
let no = Object.assign(a({ styles: V() }, (e10) => {
...
}), { displayName: "GlobalStyle" }), ns = Object.assign(a(() => {
...
}), { displayName: "CSSReset" }), nl = o(() => ({ mountPoint: () => document.body }), { name: "OverlaySetting" }), nc = o(() => new nu(c(null), c(null), () => false), { name: "Overlay" });
class nu {
  constructor(e10, t10, r10) {
...
let nd = Object.assign(a({ isOpen: H().optional(), style: V().optional(), contentRef: V().optional(), triggerRef: V().optional(), onClickOutside: V(), onEscKeydown: V(), onContentBeforeMount: V(), $transition: V().optional(), $default: V().optional() }, (e10, r10) => {
  var n7;
  let { slots: a2, attrs: i2, emit: o2 } = r10, s2 = e10.contentRef || c(null), l2 = new nu(null !== (n7 = e10.triggerRef) && void 0 !== n7 ? n7 : c(null), s2, () => !!e10.isOpen), u2 = nl.use();
  return h(nc.use().add(l2)), window && p(m(s2, "value"), b((e11) => {
    ...
    var r11;
    let n9 = e10.isOpen ? d(t("div", { ...i2, ref: s2, style: e10.style, children: t(nc, { value: l2, children: null === (r11 = a2.default) || void 0 === r11 ? void 0 : r11.call(a2) }) }), { onVnodeBeforeMount: () => {
      o2("content-before-mount");
    } }) : null;
    return t(g, { to: u2.mountPoint(), children: a2.transition ? a2.transition({ content: n9 }) : n9 });
  };
...
function nI(e10, t10, r10) {
  ...
  t10 && n_(e10) && (a2 = e10.offsetWidth > 0 && n$(n7.width) / e10.offsetWidth || 1, i2 = e10.offsetHeight > 0 && n$(n7.height) / e10.offsetHeight || 1);
...
function nV(e10) {
  ...
  return r10 && ("html" === nM(r10) || "body" === nM(r10) && "static" === nL(r10).position) ? t10 : r10 || function(e11) {
    ...
    for (nS(r11) && (r11 = r11.host); n_(r11) && 0 > ["html", "body"].indexOf(nM(r11)); ) {
      var n7 = nL(r11);
      if ("none" !== n7.transform || "none" !== n7.perspective || "paint" === n7.contain || -1 !== ["transform", "perspective"].indexOf(n7.willChange) || t11 && "filter" === n7.willChange || t11 && n7.filter && "none" !== n7.filter)
        return r11;
      r11 = r11.parentNode;
    }
    return null;
...
function nz(e10) {
  ...
  var $2 = Object.assign({ position: h2 }, m2 && nH), R2 = true === g2 ? (t10 = { x: y2, y: w2 }, r10 = nC(l2), n7 = t10.x, a2 = t10.y, { x: n$(n7 * (i2 = r10.devicePixelRatio || 1)) / i2 || 0, y: n$(a2 * i2) / i2 || 0 }) : { x: y2, y: w2 };
...
function nQ(e10, t10, r10) {
  ...
  return t10 === nb ? nZ(function(e11, t11) {
    var r11 = nC(e11), n9 = nF(e11), a3 = r11.visualViewport, i3 = n9.clientWidth, o3 = n9.clientHeight, s3 = 0, l3 = 0;
    if (a3) {
  ...
  }(e10, r10)) : nP(t10) ? ((n7 = nI(t10, false, "fixed" === r10)).top = n7.top + t10.clientTop, n7.left = n7.left + t10.clientLeft, n7.bottom = n7.top + t10.clientHeight, n7.right = n7.left + t10.clientWidth, n7.width = t10.clientWidth, n7.height = t10.clientHeight, n7.x = n7.left, n7.y = n7.top, n7) : nZ((a2 = nF(e10), o2 = nF(a2), s2 = nY(a2), l2 = null == (i2 = a2.ownerDocument) ? void 0 : i2.body, c2 = nD(o2.scrollWidth, o2.clientWidth, l2 ? l2.scrollWidth : 0, l2 ? l2.clientWidth : 0), u2 = nD(o2.scrollHeight, o2.clientHeight, l2 ? l2.scrollHeight : 0, l2 ? l2.clientHeight : 0), d2 = -s2.scrollLeft + nX(a2), f2 = -s2.scrollTop, "rtl" === nL(l2 || o2).direction && (d2 += nD(o2.clientWidth, l2 ? l2.clientWidth : 0) - c2), { width: c2, height: u2, x: d2, y: f2 }));
}
function n0(e10) {
...
function n1(e10, t10) {
  ...
  var r10, n7, a2, i2, o2, s2, l2, c2, u2 = t10, d2 = u2.placement, f2 = void 0 === d2 ? e10.placement : d2, h2 = u2.strategy, p2 = void 0 === h2 ? e10.strategy : h2, m2 = u2.boundary, g2 = u2.rootBoundary, v2 = u2.elementContext, b2 = void 0 === v2 ? ny : v2, y2 = u2.altBoundary, x2 = u2.padding, w2 = void 0 === x2 ? 0 : x2, k2 = Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }, "number" != typeof w2 ? w2 : ng.reduce(function(e11, t11) {
  ...
  }, {})), M2 = e10.rects.popper, C2 = e10.elements[void 0 !== y2 && y2 ? b2 === ny ? "reference" : ny : b2], P2 = (r10 = nP(C2) ? C2 : C2.contextElement || nF(e10.elements.popper), n7 = void 0 === m2 ? "clippingParents" : m2, a2 = void 0 === g2 ? nb : g2, l2 = (s2 = [].concat("clippingParents" === n7 ? (i2 = nJ(nB(r10)), nP(o2 = ["absolute", "fixed"].indexOf(nL(r10).position) >= 0 && n_(r10) ? nV(r10) : r10) ? i2.filter(function(e11) {
    ...
    return e11.top = nD(n9.top, e11.top), e11.right = nT(n9.right, e11.right), e11.bottom = nT(n9.bottom, e11.bottom), e11.left = nD(n9.left, e11.left), e11;
...
var n3 = (Y = void 0 === (G = (U = { defaultModifiers: [{ name: "eventListeners", enabled: true, phase: "write", fn: function() {
  ...
  void 0 === r10 && (r10 = K);
  var n7, a2, i2 = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, n4, K), modifiersData: {}, elements: { reference: e10, popper: t10 }, attributes: {}, styles: {} }, o2 = [], s2 = false, l2 = { state: i2, setOptions: function(r11) {
    ...
    var h2 = (a3 = Object.keys(n9 = [].concat(Y, i2.options.modifiers).reduce(function(e11, t11) {
...
let n6 = Object.assign(a({ isOpen: nd.propTypes.isOpen, onClickOutside: nd.propTypes.onClickOutside, placement: V().optional(), modifiers: V().optional(), $transition: nd.propTypes.$transition, $content: V(), $default: V() }, (e10, n7) => {
  let { slots: a2, emit: i2, attrs: o2 } = n7, s2 = c(null), l2 = c(null);
  return y(() => l2.value, (t10) => {
    if (t10 && s2.value) {
      var r10, n9;
      n3(s2.value, t10, { placement: null !== (r10 = e10.placement) && void 0 !== r10 ? r10 : "bottom", modifiers: [...null !== (n9 = e10.modifiers) && void 0 !== n9 ? n9 : [], n2] });
    }
  }), () => {
    var n9, c2;
    let u2 = null === (n9 = a2.default) || void 0 === n9 ? void 0 : n9.call(a2)[0];
    return u2 ? r(x, { children: [d(u2, { ...o2, onVnodeMounted: (e11) => {
    ...
    } }), t(nd, { triggerRef: s2, contentRef: l2, isOpen: e10.isOpen, onClickOutside: (e11) => i2("click-outside", e11), style: { zIndex: 100 }, $transition: a2.transition, children: null === (c2 = a2.content) || void 0 === c2 ? void 0 : c2.call(a2) })] }) : null;
  };

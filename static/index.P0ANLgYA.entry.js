...
var _a;
import { c as custom, _ as __vitePreload, o as object, d as annotate, s as string, u as union, e as integer, n as nativeEnum, r as record, f as optional, a as array, b as any, h as boolean, j as enums } from "./lib-nodepkg-typedef.fsPa1Imn.chunk.js";
import { f as component, v as useRouter, j as jsx, g as ref, d as jsxs, w as watch, R as RouterView, x as RouterLink, y as createRouter, z as createWebHistory, A as createApp, r as rx, s as subscribeUntilUnmount, F as Fragment, B as defineComponent, C as h, D as Fragment$1, e as ref$1, a as component$, o as observableRef, h as render } from "./lib-nodepkg-vuekit.BiY9xEjN.chunk.js";
import { a as Icon, I as IconButton, T as Tooltip, b as TextButton, D as Dialog, c as DialogContainer, M as Menu, L as ListItem, F as FilledButton, O as OutlinedButton, d as TonalButton, E as ElevatedButton, e as TextField } from "./lib-nodepkg-vuematerial.Chejfejr.chunk.js";
import { e as mdiGithub, f as mdiWeatherNight, g as mdiWhiteBalanceSunny, C as Container, D as DynamicThemingProvider, h as mdiClose, i as mdiSend, j as mdiPlus, k as mdiAccount } from "./webapp-vuekit-layout.ChKPGwhJ.chunk.js";
import { B as Box, C as CacheProvider, c as CSSReset, G as GlobalStyle, T as ThemeProvider, e as Theming, f as Palette, g as defaultTheme, s as styled, v as variant, b as alpha, a as size, P as Popper, d as defineTransition, t as transition } from "./lib-nodepkg-vueuikit.DVj8lKN8.chunk.js";
import { v as groupBy, w as map, p as partition, l as last, x as upperFirst } from "./vendor-innoai-tech-lodash.D1Wq5XWs.chunk.js";
import { c as cIndexDefault, _ as __pages_import_16__page_meta__ } from "./webapp-vuekit-page.BcruZcXx.chunk.js";
import { J as JSONEditor, a as JSONEditorProvider, b as JSONEditorView, c as copyToClipboard } from "./lib-nodepkg-jsoneditor.DGxVndsx.chunk.js";
import { t as tap, g as debounceTime } from "./vendor-rxjs.Dpbcb-XH.chunk.js";
import { M as Markdown } from "./lib-nodepkg-vuemarkdown.WjBOQOQA.chunk.js";
...
const Nav = component(() => {
  ...
  return () => {
    return /* @__PURE__ */ jsx(Box, {
      ...
      children: map(groups, (routes2, group) => {
        var _a2;
        const [index2, subRoutes] = partition(routes2, (r2) => r2.path === `/${group}`);
        return /* @__PURE__ */ jsxs(Box, {
          sx: {
            px: 8
          },
          children: [
            index2[0] ? /* @__PURE__ */ jsx(TextButton, {
              ...
              activeClass: "active",
              to: (_a2 = index2[0]) == null ? void 0 : _a2.path,
              children: group
            ...
            /* @__PURE__ */ jsx(Box, {
              ...
              children: map(subRoutes, (subRoute) => {
                var _a3;
                return /* @__PURE__ */ jsx(TextButton, {
                  ...
                  children: (_a3 = last(subRoute.path.split("/"))) == null ? void 0 : _a3.replaceAll("-", " ")
                }, subRoute.name);
              })
            })
          ]
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(Tooltip, {
                  ...
                  children: /* @__PURE__ */ jsx(Box, {
                    ...
                    children: /* @__PURE__ */ jsx(Icon, {
                      path: themeMode.value === "light" ? mdiWeatherNight : mdiWhiteBalanceSunny
                    })
                  })
                })
              ]
...
const routes = [
  ...
  },
  {
    "name": "index",
    "path": "/",
    "component": Object.assign(cIndexDefault, __pages_import_16__page_meta__),
    "props": true
  }
];
console.log(routes);
...
const cButtonsDefault = component(() => {
  ...
  return () => /* @__PURE__ */ jsx(Container, {
    children: /* @__PURE__ */ jsx(Box, {
      ...
      children: map(buttons2, (Button2, name) => /* @__PURE__ */ jsx(Box, {
        sx: {
          display: "flex",
          flexDirection: "column",
          gap: 16
        ...
        ].map((render2, i) => /* @__PURE__ */ jsx(Fragment$1, {
          children: /* @__PURE__ */ jsx(Box, {
            sx: {
              display: "flex",
              gap: 16
            },
            children: map(stateProps, (props, name2) => /* @__PURE__ */ jsx(Button2, {
              ...props,
              children: render2(name2)
            }))
          })
        }, `${i}`))
      }, name))
...
const cTextfieldsDefault = component(() => {
  ...
  return () => /* @__PURE__ */ jsx(Container, {
    children: /* @__PURE__ */ jsx(Box, {
      ...
      children: map(buttons2, (TextField2, name) => /* @__PURE__ */ jsx(Box, {
        sx: {
          display: "flex",
          flexDirection: "column",
          gap: 16
        ...
        children: [
          ...
          children: /* @__PURE__ */ jsx(Box, {
            ...
            children: map(stateProps, (props) => render2({
              ...props,
              $label: "Name",
              $supporting: "Desc"
            }))
...
const cTypographyDefault = component(() => {
  ...
  return () => /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsx(Box, {
      ...
      children: theme.token.textStyle.tokens.map((textStyle) => /* @__PURE__ */ jsxs(Box, {
        sx: {
          flex: 1,
          rounded: "md",
          textStyle,
                  ...
                  children: [
                    /* @__PURE__ */ jsx(Box, {
                      ...
                      children: [
                        "",
                        "-container"
                      ].map((suffix) => /* @__PURE__ */ jsxs(Fragment$1, {
                        children: [
                          /* @__PURE__ */ jsx(Box, {
                            sx: {
                    ...
                    /* @__PURE__ */ jsx(Box, {
                      ...
                      children: map(tones, (_, k) => /* @__PURE__ */ jsxs(Box, {
                        sx: {
      ...
      children: [
        /* @__PURE__ */ jsxs(Box, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Box, {
              ...
              children: map(p.value.rules, (param, role) => {
                let [base2, tone] = param;
                return /* @__PURE__ */ jsxs(Box, {
                  sx: {
                    display: "flex",
                    alignItems: "center",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx(Box, {
                      ...
                      children: /* @__PURE__ */ jsx("input", {
                        ...
                        min: 0,
                        style: {
                          backgroundColor: Palette.toHEX(pp.seeds[base2].tone(tone)),
                          color: tone > 50 ? "black" : "white"
                        },
                        "data-color": Palette.toHEX(pp.seeds[base2].tone(tone)),
                        "data-theme": "dark",
                        onChange: (evt) => {
                          try {
        ...
        /* @__PURE__ */ jsx(Box, {
          ...
          children: /* @__PURE__ */ jsx("pre", {
            onClick: () => copyToClipboard(JSON.stringify(p.value)),
            children: /* @__PURE__ */ jsx("code", {
              children: JSON.stringify(p.value, null, 2)
            })
          })
        })
      ]
...
const cFigmaTokensDefault = component(() => {
  ...
  return () => {
    return /* @__PURE__ */ jsxs(Box, {
      ...
      children: [
        /* @__PURE__ */ jsx("div", {
          children: "点击下载，通过 Figma Tokens 全量导入文件"
        }),
        /* @__PURE__ */ jsx("pre", {
          onClick: () => {
          ...
          children: /* @__PURE__ */ jsx("code", {
            children: JSON.stringify(t.toFigmaTokens(), null, 2)
          })
        })
      ]
    });
...
function download(data, filename) {
  let type = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "application/json";
...
const cElevationDefault = component(() => {
  const theme = ThemeProvider.use();
  return () => /* @__PURE__ */ jsx(Fragment, {
    children: Object.keys(theme.token.elevation.tokens).map((elevation2) => /* @__PURE__ */ jsx(Box, {
      sx: {
        mt: 16,
        p: 16,
        rounded: "lg",
...
const cIndexMdCodeBlock785F3Ec7Default = component(() => () => /* @__PURE__ */ jsx(Box, {
  sx: {
    display: "flex",
    padding: 10,
...
const cPopperMdCodeBlock4A44Dc15Default = component(() => {
  ...
  return () => /* @__PURE__ */ jsx(Popper, {
    ...
    $transition: (param) => {
      let { content } = param;
      return /* @__PURE__ */ jsx(FadeInOutTransition, {
        children: content
      });
    },
    $content: /* @__PURE__ */ jsxs(Box, {
...
const cRxInVueMdCodeBlockd4735E3ADefault = component(() => {
  ...
  return () => /* @__PURE__ */ jsx("div", {
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [
        /* @__PURE__ */ jsx(TextDebounceInput, {
  ...
  return () => {
    ...
    return /* @__PURE__ */ jsxs("dl", {
      children: [
        ...
        /* @__PURE__ */ jsx("dd", {
          children: (_b = slots.title) == null ? void 0 : _b.call(slots)
        }),
        /* @__PURE__ */ jsx("dt", {
          children: "item"
        }),
        /* @__PURE__ */ jsx("dd", {
          children: options.map((option) => {
            var _a3;
            return (_a3 = slots.item) == null ? void 0 : _a3.call(slots, option);
          })
        })
      ]
    });

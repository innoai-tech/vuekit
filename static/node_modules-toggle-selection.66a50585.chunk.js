...
import { b as l, B as n } from "./lib-nodepkg-vueuikit.a0bf8d00.chunk.js";
...
let u = o(function(e2, t2) {
  ...
  try {
    ...
    try {
      ...
      o2 && console.error("unable to copy using clipboardData: ", n4), o2 && console.error("falling back to prompt"), a2 = "message" in t2 ? t2.message : "Copy to clipboard: #{key}, Enter", r2 = (/mac os x/i.test(navigator.userAgent) ? "⌘" : "Ctrl") + "+C", l2 = a2.replace(/#{\s*key\s*}/g, r2), window.prompt(l2, e2);
    }
  } finally {

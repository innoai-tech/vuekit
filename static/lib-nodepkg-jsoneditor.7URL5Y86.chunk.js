...
var _e, _t, _n;
import { c as e, I as t, j as n, a as l, r as a, b as i, d as r, T as o, F as d, e as s, s as c, g as p, f as u, o as h, t as v, h as y } from "./lib-nodepkg-vuekit.DoFTB1Dl.chunk.js";
import { o as m, J as f, S as x, E as g } from "./lib-nodepkg-typedef.CHCjapSZ.chunk.js";
import { O as b, s as w, m as N, f as C, d as $, t as k, E as S, c as E, B as O, S as T } from "./vendor-rxjs.CVNc_enA.chunk.js";
import { i as I, g as A, a as D, b as L, s as P, l as M, c as R, d as _ } from "./vendor-innoai-tech-lodash.B5yuHYMQ.chunk.js";
import { s as J, v as j, a as B, P as z, b as H, B as W } from "./lib-nodepkg-vueuikit.H4lnJYLE.chunk.js";
import { I as U, a as V } from "./lib-nodepkg-vuematerial.B0Y-w5TZ.chunk.js";
import { m as F, a as K, b as X, c as q } from "./webapp-vuekit-layout.BfG2n9Cl.chunk.js";
...
let Q = /* @__PURE__ */ e(() => new G(m(), {})), Y = /* @__PURE__ */ e(() => ({})), Z = /* @__PURE__ */ J("span", { displayName: "ActionToolbar" })({ px: 2, pos: "relative", display: "flex", alignItems: "center", gap: 8, visibility: "hidden" }), ee = /* @__PURE__ */ J("span", (e2, t2) => {
  ...
  let { slots: l2, render: a2 } = t2, i2 = /* @__PURE__ */ es.use(), d2 = /* @__PURE__ */ s(Q.use().error$, /* @__PURE__ */ a2((t3) => {
    ...
    return /* @__PURE__ */ r(ed, { "data-error": d3, "data-dirty": e2.dirty, style: { paddingLeft: `${32 * i2.indent}px` }, children: [e2.title && /* @__PURE__ */ n(er, { style: { paddingLeft: `${32 * i2.indent}px` }, children: e2.title }), /* @__PURE__ */ n(ey, { children: null === (a3 = l2.default) || void 0 === a3 ? void 0 : a3.call(l2) }), d3 && /* @__PURE__ */ n(eo, { children: `${t3[o2]}` })] });
  }));
...
let e$ = /* @__PURE__ */ p(function(e2, t2) {
  ...
  let {} = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "复制当前节点为 JSON 字符串", children: /* @__PURE__ */ n(et, { onClick: () => e$(/* @__PURE__ */ JSON.stringify(e2.value, null, 2)), children: /* @__PURE__ */ n(V, { path: F }) }) });
...
let eD = /* @__PURE__ */ e(() => new eA()), eL = /* @__PURE__ */ l((e2, l2) => {
  let a2, { render: i2 } = l2, o2 = /* @__PURE__ */ h(null), p2 = /* @__PURE__ */ h(null), u2 = /* @__PURE__ */ h(null), y2 = /* @__PURE__ */ eI.from(u2), m2 = /* @__PURE__ */ eD.use(), f2 = /* @__PURE__ */ ef.from(u2), g2 = /* @__PURE__ */ Q.use();
  ...
  let b2 = () => {
    ...
    if (i3) {
      g2.setError(e2.ctx.path, i3.message);
      return;
    }
    g2.update(e2.ctx.path, r2), f2.hide();
  };
  return (s(y2, /* @__PURE__ */ k((e3) => {
    ...
    return S;
  }))), /* @__PURE__ */ c()), "enums" == e2.typedef.type) ? s(/* @__PURE__ */ E([e2.value$, f2, O2]), /* @__PURE__ */ i2((t2) => {
    var l3, a3, i3;
    let [r2, o3, { index: s2 }] = t2, c2 = null !== (l3 = /* @__PURE__ */ x.schemaProp(e2.typedef, "enum")) && void 0 !== l3 ? l3 : [], h2 = null !== (a3 = /* @__PURE__ */ x.metaProp(e2.typedef, "enumLabels")) && void 0 !== a3 ? a3 : [];
    return /* @__PURE__ */ n(eM, { ref: p2, onClick: () => {
      f2.show();
    }, "data-type": typeof r2, tabindex: 0, onFocus: () => {
      f2.hide();
    }, children: o3 ? /* @__PURE__ */ n(eg, { onSelected: (e3) => {
      I2(e3);
    }, open$: f2, $content: /* @__PURE__ */ n(d, { children: /* @__PURE__ */ c2.map((e3, t3) => /* @__PURE__ */ n(e_, { "data-focus": s2 % c2.length === t3, value: e3, label: h2[t3] })) }), children: /* @__PURE__ */ n("input", { value: void 0 == r2 ? "" : `${r2}`, ref: u2, "data-options": true }) }) : /* @__PURE__ */ n("span", { children: null !== (i3 = /* @__PURE__ */ JSON.stringify(r2)) && void 0 !== i3 ? i3 : "undefined" }) });
  })) : s(/* @__PURE__ */ E([e2.value$, f2]), /* @__PURE__ */ i2((e3) => {
    var t2;
    let [l3, a3] = e3;
    return /* @__PURE__ */ n(eM, { ref: p2, onClick: () => {
      f2.show();
      ...
      f2.show();
    }, children: a3 ? /* @__PURE__ */ n(z, { isOpen: true, placement: "right-start", $content: /* @__PURE__ */ r(eP, { ref: o2, children: [/* @__PURE__ */ n(et, { onClick: () => y2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(V, { path: K }) }), /* @__PURE__ */ n(et, { onClick: () => y2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(V, { path: X }) })] }), children: /* @__PURE__ */ n("textarea", { ref: u2, rows: 1, value: void 0 == l3 ? "" : `${l3}` }) }) : /* @__PURE__ */ n("span", { "data-value": true, children: null !== (t2 = /* @__PURE__ */ JSON.stringify(l3)) && void 0 !== t2 ? t2 : "undefined" }) });
  }));
  ...
  let {} = e2, { emit: l2 } = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "删除属性", children: /* @__PURE__ */ n(et, { onClick: () => l2("remove"), children: /* @__PURE__ */ n(V, { path: q }) }) });
  ...
  let { emit: a2, render: i2 } = l2, o2 = /* @__PURE__ */ h(null), d2 = /* @__PURE__ */ eI.from(o2), p2 = /* @__PURE__ */ eT.from(o2), u2 = /* @__PURE__ */ ef.from(o2), v2 = /* @__PURE__ */ Q.use(), y2 = new t({ index: 0 }), m2 = () => {
  ...
  let { emit: l2, render: a2 } = t2, i2 = /* @__PURE__ */ h(null), o2 = /* @__PURE__ */ eT.from(i2), d2 = /* @__PURE__ */ eI.from(i2), p2 = /* @__PURE__ */ ef.from(i2), u2 = /* @__PURE__ */ Q.use(), v2 = () => {
  ...
  let m2 = /* @__PURE__ */ s(p2, /* @__PURE__ */ a2((e3) => /* @__PURE__ */ n(z, { isOpen: e3, placement: "right-start", $content: /* @__PURE__ */ r(eP, { children: [/* @__PURE__ */ n(et, { onClick: () => d2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(V, { path: K }) }), /* @__PURE__ */ n(et, { onClick: () => d2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(V, { path: X }) })] }), children: /* @__PURE__ */ n("input", { ref: i2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) })));
  ...
  let {} = e2, { emit: l2 } = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "移除项", children: /* @__PURE__ */ n(et, { onClick: () => l2("remove"), children: /* @__PURE__ */ n(V, { path: q }) }) });
  ...
  let {} = e2, { render: l2 } = t2, a2 = /* @__PURE__ */ Q.use(), i2 = /* @__PURE__ */ Y.use(), o2 = /* @__PURE__ */ y(null);

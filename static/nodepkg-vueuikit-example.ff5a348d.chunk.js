import{b as a,j as e,c as r,P as p,Q as d,F as m}from"./lib-nodepkg-vuekit.a520e887.chunk.js";import{s as h,v as c,a as t,B as l}from"./lib-nodepkg-vueuikit.5b5fb350.chunk.js";import{b as u}from"./lib-nodepkg-typedef.f090c55a.chunk.js";const k=h("button",{disabled:u().optional()})({bg:"none",outline:"none",border:"none",px:16,h:40,rounded:"md",color:"sys.primary",bgColor:c("sys.primary",t(.08)),_disabled:{color:c("sys.on-surface",t(.12)),bgColor:c("sys.on-surface",t(.08))}}),N=()=>a(l,{sx:{display:"flex",gap:8},children:[e(o,{children:"按钮"}),e(o,{disabled:!0,children:"按钮"})]}),o=Object.assign(k,{displayName:"Button"}),g=r(()=>()=>e(l,{sx:{display:"flex",padding:10,containerStyle:"sys.primary"},children:e(l,{sx:{containerStyle:"sys.surface-container"},component:"button",children:"Hi 111"})})),y=Object.assign(g,{displayName:"IndexMdCodeBlock785F3Ec7Default"});function i(s){const n=Object.assign({p:"p",a:"a",code:"code",h2:"h2",div:"div",codeblock4a44dc15:"codeblock4a44dc15",pre:"pre",span:"span",codeblock785f3ec7:"codeblock785f3ec7",h3:"h3",ul:"ul",li:"li",em:"em",strong:"strong"},s.components);return a(m,{children:[a(n.p,{children:["设计理念沿用 ",e(n.a,{href:"https://m3.material.io/",children:"Material 3"})]}),`
...
`]}),`
`]}),`
`]})]})}function b(){let s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};const{wrapper:n}=s.components||{};return n?e(n,Object.assign({},s,{children:e(i,s)})):i(s)}const f=p(()=>()=>d(b,{components:{codeblock4a44dc15:N,codeblock785f3ec7:y}})),B=Object.assign(f,{displayName:"IndexDefault"});export{B as default};

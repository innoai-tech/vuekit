...
var _e, _t, _n;
var e, t, n, a;
import { c as r, I as i, j as l, a as o, r as s, s as d, b as p, d as c, e as u, f as h, T as y, F as m, o as f, t as x, g as v } from "./lib-nodepkg-vuekit.CIsNCF-g.chunk.js";
import { J as b, o as g, g as w, S as N, a as C, b as k, r as S, s as $, E as O } from "./lib-nodepkg-typedef.C7Xzglrl.chunk.js";
import { s as E, a as I, P as T, v as A, b as D, B as R } from "./lib-nodepkg-vueuikit.BdMrlkkf.chunk.js";
import { I as J, a as L } from "./lib-nodepkg-vuematerial.Bu6nYbKn.chunk.js";
import { m as P, a as M, b as B, c as _, d as j } from "./webapp-vuekit-layout.DO0wZfo8.chunk.js";
import { O as W, s as z, m as H, f as F, d as U, t as V, E as K, c as X, B as q, S as G } from "./vendor-rxjs.CsPENGSS.chunk.js";
...
import { M as el } from "./lib-nodepkg-vuemarkdown.EHHcrJVJ.chunk.js";
...
let ef = E("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: A("sys.outline-variant", D(0.38)) }), ex = E("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), ev = o((e6, t2) => {
  ...
  return s(r2, a2((t3) => {
    ...
    return l(T, { isOpen: t3, placement: e6.placement ?? "left", $content: l(eg, { children: l(eb, { children: n2.title() }) }), children: a3 ? p(a3, { onMouseover: () => {
      r2.show();
    }, onMouseout: () => {
      r2.hide();
    } }) : null });
  ...
  let { slots: n2, render: a2 } = t2, r2 = eE.use(), i2 = s(es.use().error$, a2((t3) => {
    ...
    return c(eO, { "data-error": i3, "data-dirty": e6.dirty, style: { paddingLeft: `${32 * r2.indent}px` }, children: [(e6.title || e6.description) && l(eS, { style: { paddingLeft: `${32 * r2.indent}px` }, children: e6.description ? l(ev, { $title: l(eL, { children: l(el, { text: e6.description }) }), children: c("div", { children: [e6.title, " ", l(L, { path: P })] }) }) : l("span", { children: e6.title }) }), l(eJ, { children: (_a = n2.default) == null ? void 0 : _a.call(n2) }), i3 && l(e$, { children: `${t3[a3]}` })] });
  }));
...
let ez = r(() => new eW()), eH = o((e6, t2) => {
  let n2, { render: a2 } = t2, r2 = f(null), o2 = f(null), p2 = f(null), u2 = ej.from(p2), h2 = e_.from(p2), y2 = ez.use(), m2 = eh.from(p2), v2 = es.use();
  ...
  let { emit: n2, render: a2 } = t2, r2 = f(null), o2 = ej.from(r2), p2 = e_.from(r2), u2 = eh.from(r2), h2 = es.use(), y2 = new i({ index: 0 }), m2 = () => {
  ...
  let { emit: n2, render: a2 } = t2, r2 = f(null), i2 = e_.from(r2), o2 = ej.from(r2), p2 = eh.from(r2), u2 = es.use(), h2 = () => {

...
`,e(n.span,{className:"token keyword module",children:"import"})," ",a(n.span,{className:"token imports",children:[e(n.span,{className:"token punctuation",children:"{"})," z ",e(n.span,{className:"token punctuation",children:"}"})]})," ",e(n.span,{className:"token keyword module",children:"from"})," ",e(n.span,{className:"token string",children:'"@innoai-tech/vuekit"'}),e(n.span,{className:"token punctuation",children:";"}),`
...
另外样式扩展有两种方式`]}),`
`,e(n.pre,{className:"language-tsx",children:a(n.code,{className:"language-tsx",children:[e(n.span,{className:"token keyword module",children:"import"})," ",a(n.span,{className:"token imports",children:[e(n.span,{className:"token punctuation",children:"{"})," z ",e(n.span,{className:"token punctuation",children:"}"})]})," ",e(n.span,{className:"token keyword module",children:"from"})," ",e(n.span,{className:"token string",children:'"@innoai-tech/vuekit"'}),e(n.span,{className:"token punctuation",children:";"}),`
...
`]}),`
`]}),`
`]})]})}function b(){let s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};const{wrapper:n}=s.components||{};return n?e(n,Object.assign({},s,{children:e(i,s)})):i(s)}const f=d(()=>()=>m(b,{components:{codeblock4a44dc15:N,codeblock785f3ec7:y}})),w=Object.assign(f,{displayName:"IndexDefault"});export{w as default};

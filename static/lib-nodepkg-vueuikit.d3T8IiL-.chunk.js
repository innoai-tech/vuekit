...
let e;
import { c as t, j as r, T as n, d as a, o as i, e as o, i as s, f as l, r as c, g as u, a as d, u as f, h, k as p, t as m, l as g, s as y, m as b, n as v, b as x, F as w } from "./lib-nodepkg-vuekit.Bvr5MxNo.chunk.js";
import { c as k } from "./lib-nodepkg-typedef.Czd731t_.chunk.js";
import { k as C, g as M, b as P, l as _, s as S, e as R, f as T, h as D, j as $, i as O, o as I, m as A, n as L, q as F, a as B, c as V, r as E, t as H, u as z } from "./vendor-innoai-tech-lodash.BQbaWOEd.chunk.js";
import { _ as j, c as W } from "./vendor-rxjs.sYPTaurm.chunk.js";
...
function er(e10) {
  var { from: t10 = 0, to: r10 = 1, restSpeed: n6 = 2, restDelta: a2 } = e10, i2 = j(e10, ["from", "to", "restSpeed", "restDelta"]);
  let o2 = { done: false, value: t10 }, { stiffness: s2, damping: l2, mass: c2, velocity: u2, duration: d2, isResolvedFromDuration: f2 } = function(e11) {
    ...
    if (!et(e11, ee) && et(e11, Q)) {
      let r11 = function(e12) {
        ...
        s3 = J(0.05, 1, s3), n7 = J(0.01, 10, n7 / 1e3), s3 < 1 ? (t12 = (e13) => {
...
let em = (e10, t10) => (r10) => !!(ed(r10) && eu.test(r10) && r10.startsWith(e10) || t10 && Object.prototype.hasOwnProperty.call(r10, t10)), eg = (e10, t10, r10) => (n6) => {
  ...
  return "hsla(" + Math.round(t10) + ", " + ep.transform(es(r10)) + ", " + ep.transform(es(n6)) + ", " + es(eh.transform(a2)) + ")";
} }, eb = eo(0, 255), ev = Object.assign(Object.assign({}, ef), { transform: (e10) => Math.round(eb(e10)) }), ex = { test: em("rgb", "red"), parse: eg("red", "green", "blue"), transform: (e10) => {
...
}, eD = [ew, ex, ey], e$ = (e10) => eD.find((t10) => t10.test(e10)), eO = (e10, t10) => {
  let r10 = e$(e10), n6 = e$(t10), a2 = r10.parse(e10), i2 = n6.parse(t10);
  r10 === ey && (a2 = eR(a2), r10 = ex), n6 === ey && (i2 = eR(i2), n6 = ex);
...
let eH = (e10, t10) => {
  ...
  return n6.numHSL === a2.numHSL && n6.numRGB === a2.numRGB && n6.numNumbers >= a2.numNumbers ? eL(eB(n6.parsed, a2.parsed), r10) : (r11) => `${r11 > 0 ? t10 : e10}`;
...
function ej(e10, t10) {
  ...
  let o2 = function(e11, t11, r11) {
    ...
    for (let r12 = 0; r12 < o3; r12++) {
      ...
      t11 && (n8 = eL(Array.isArray(t11) ? t11[r12] : t11, n8)), a3.push(n8);
    }
    return a3;
...
function e7(e10) {
  ...
  (null === (a2 = C2.needsInterpolation) || void 0 === a2 ? void 0 : a2.call(C2, i2, b2)) && (n6 = ej([0, 100], [i2, b2], { clamp: false }), i2 = 0, b2 = 100);
  let M2 = C2(Object.assign(Object.assign({}, y2), { from: i2, to: b2 }));
  return o2 && (null == f2 || f2(), (t10 = s2(function(e11) {
    ...
    if (null == g2 || g2(r10), w2) {
      if (0 === v2 && (null != x2 || (x2 = l2)), v2 < c2) {
        var a3, i3;
        a3 = l2, i3 = x2, (k2 ? a3 >= i3 + d2 : a3 <= -d2) && (v2++, "reverse" === u2 ? l2 = function(e12, t11) {
        ...
        }(l2, x2, d2, k2 = v2 % 2 == 0) : (l2 = e6(l2, x2, d2), "mirror" === u2 && M2.flipTarget()), w2 = false, m2 && m2());
      } else t10.stop(), p2 && p2();
    }
  })).start()), { stop: () => {
    null == h2 || h2(), t10.stop();
...
__publicField(_tk, "walkStateValues", function(e10, t10) {
  ...
  for (let e11 in a2) {
    var i2;
    let o2 = a2[e11], s2 = null !== (i2 = a2.default) && void 0 !== i2 ? i2 : r10.default, l2 = null != n6 ? n6 : M(s2, [...r10.path.slice(1), "$"]), c2 = l2 ? [...r10.selectorPath, l2] : r10.selectorPath, u2 = [...r10.path, e11];
    if (P(o2)) {
...
class tM {
  ...
  static color(e10) {
    return tM.create("var", { value: e10, on: tx(tv.color, tv.bgColor, tv.outlineColor, tv.borderColor, tv.accentColor, tv.fill, tv.stroke), transform: (e11, t10) => T(e11) ? { default: `var(${t10(e11)})`, rgb: `var(${t10(`${e11}/rgb`)})` } : { default: `rgb(${e11[0]}, ${e11[1]}, ${e11[2]})`, rgb: `${e11[0]} ${e11[1]} ${e11[2]}` }, fallback: "" });
  }
  static space(e10) {
...
const _tA = class _tA {
      ...
      if (t11) {
        if (t11.type === tC.var) {
          ...
          for (let t12 of e11.tokens) for (let r11 of ["light", "dark"]) {
            ...
            V(i2) || ("_default" === n7 ? S(this.cssVars, [this.cssVar(a2, t12)], i2) : S(this.cssVars, [n7, this.cssVar(a2, t12)], i2));
          }
          continue;
        }
  ...
  unstable_css(e10, t10) {
    ...
    return n6.__emotion_styles = null !== (r10 = n6.__emotion_styles) && void 0 !== r10 ? r10 : function(e11, t11, r11) {
      ...
      th.lastIndex = 0;
      for (var l2 = ""; null !== (n7 = th.exec(i2)); ) l2 += "-" + n7[1];
  ...
  toFigmaTokens() {
    let e10 = { space: { dp: { $type: "sizing", $value: 1 } } }, t10 = {}, r10 = {}, n6 = (e11, t11) => O(t11) ? { $type: e11, $value: A(t11, (t12) => n6(e11, t12).$value) } : T(t11) ? { $type: e11, $value: t11.replace(/var\(([^)]+)\)/g, (e12) => {
      var t12, r11;
...
let tL = { shadow: tM.shadow({ 0: { _default: "0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px 0px rgba(0, 0, 0, 0)", _dark: "0px 0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px rgba(0, 0, 0, 0)" }, 1: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 1px 3px 1px rgba(0, 0, 0, 0.15)", _dark: "0px 1px 3px 1px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 2: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 2px 6px 2px rgba(0, 0, 0, 0.15)", _dark: "0px 2px 6px 2px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 3: { _default: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)" }, 4: { _default: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)" }, 5: { _default: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)", _dark: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)" } }), elevation: tM.customMixin("elevation", { 0: tM.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "0", _hover: { shadow: "1" } }), 1: tM.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "1", _hover: { shadow: "2" } }), 2: tM.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "2", _hover: { shadow: "3" } }), 3: tM.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "3", _hover: { shadow: "4" } }), 4: tM.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "4", _hover: { shadow: "5" } }) }) }, tF = (e10, t10, r10, n6) => Object.assign(function(e11, t11, r11, n7) {
  ...
  return (i2) => 0 === i2 || 1 === i2 ? i2 : tn(function(t12) {
    ...
    let o2 = n8 + (t12 - a2[--i3]) / (a2[i3 + 1] - a2[i3]) * 0.1, s2 = ta(o2, e11, r11);
    return s2 >= 1e-3 ? function(e12, t13, r12, n9) {
      for (let a3 = 0; a3 < 8; ++a3) {
        let a4 = ta(t13, r12, n9);
        if (0 === a4) break;
...
class t1 {
  ...
  static fromIntInViewingConditions(e10, t10) {
    let r10 = tJ((16711680 & e10) >> 16), n6 = tJ((65280 & e10) >> 8), a2 = tJ(255 & e10), i2 = 0.41233895 * r10 + 0.35762064 * n6 + 0.18051042 * a2, o2 = 0.2126 * r10 + 0.7152 * n6 + 0.0722 * a2, s2 = 0.01932141 * r10 + 0.11916382 * n6 + 0.95034478 * a2, l2 = t10.rgbD[0] * (0.401288 * i2 + 0.650173 * o2 - 0.051461 * s2), c2 = t10.rgbD[1] * (-0.250268 * i2 + 1.204414 * o2 + 0.045854 * s2), u2 = t10.rgbD[2] * (-2079e-6 * i2 + 0.048952 * o2 + 0.953127 * s2), d2 = Math.pow(t10.fl * Math.abs(l2) / 100, 0.42), f2 = Math.pow(t10.fl * Math.abs(c2) / 100, 0.42), h2 = Math.pow(t10.fl * Math.abs(u2) / 100, 0.42), p2 = 400 * tH(l2) * d2 / (d2 + 27.13), m2 = 400 * tH(c2) * f2 / (f2 + 27.13), g2 = 400 * tH(u2) * h2 / (h2 + 27.13), y2 = (11 * p2 + -12 * m2 + g2) / 11, b2 = (p2 + m2 - 2 * g2) / 9, v2 = 180 * Math.atan2(b2, y2) / Math.PI, x2 = v2 < 0 ? v2 + 360 : v2 >= 360 ? v2 - 360 : v2, w2 = x2 * Math.PI / 180, k2 = 100 * Math.pow((40 * p2 + 20 * m2 + g2) / 20 * t10.nbb / t10.aw, t10.c * t10.z), C2 = 4 / t10.c * Math.sqrt(k2 / 100) * (t10.aw + 4) * t10.fLRoot, M2 = Math.pow(5e4 / 13 * (0.25 * (Math.cos((x2 < 20.14 ? x2 + 360 : x2) * Math.PI / 180 + 2) + 3.8)) * t10.nc * t10.ncb * Math.sqrt(y2 * y2 + b2 * b2) / ((20 * p2 + 20 * m2 + 21 * g2) / 20 + 0.305), 0.9) * Math.pow(1.64 - Math.pow(0.29, t10.n), 0.73), P2 = M2 * Math.sqrt(k2 / 100), _2 = P2 * t10.fLRoot, S2 = 50 * Math.sqrt(M2 * t10.c / (t10.aw + 4)), R2 = 1 / 0.0228 * Math.log(1 + 0.0228 * _2);
...
class t8 {
  ...
  getTone(e10) {
    ...
    if (this.toneDeltaPair) {
      let r10 = this.toneDeltaPair(e10), n6 = r10.roleA, a2 = r10.roleB, i2 = r10.delta, o2 = r10.polarity, s2 = r10.stayTogether, l2 = this.background(e10).getTone(e10), c2 = "nearer" === o2 || "lighter" === o2 && !e10.isDark || "darker" === o2 && e10.isDark, u2 = c2 ? n6 : a2, d2 = c2 ? a2 : n6, f2 = this.name === u2.name, h2 = e10.isDark ? 1 : -1, p2 = u2.contrastCurve.getContrast(e10.contrastLevel), m2 = d2.contrastCurve.getContrast(e10.contrastLevel), g2 = u2.tone(e10), y2 = t5.ratioOfTones(l2, g2) >= p2 ? g2 : t8.foregroundTone(l2, p2), b2 = d2.tone(e10), v2 = t5.ratioOfTones(l2, b2) >= m2 ? b2 : t8.foregroundTone(l2, m2);
      return t10 && (y2 = t8.foregroundTone(l2, p2), v2 = t8.foregroundTone(l2, m2)), (v2 - y2) * h2 >= i2 || ((v2 = tz(0, 100, y2 + i2 * h2)) - y2) * h2 >= i2 || (y2 = tz(0, 100, v2 - i2 * h2)), 50 <= y2 && y2 < 60 ? v2 = h2 > 0 ? Math.max(v2, (y2 = 60) + i2 * h2) : Math.min(v2, (y2 = 49) + i2 * h2) : 50 <= v2 && v2 < 60 && (v2 = s2 ? h2 > 0 ? Math.max(v2, (y2 = 60) + i2 * h2) : Math.min(v2, (y2 = 49) + i2 * h2) : h2 > 0 ? 60 : 49), f2 ? y2 : v2;
    }
    {
...
class rn {
  ...
  static createKeyColor(e10, t10) {
    let r10 = t4.from(e10, t10, 50), n6 = Math.abs(r10.chroma - t10);
...
class ra {
  ...
  constructor(e10, t10) {
    ...
    t10 ? (this.a1 = rn.fromHueAndChroma(n6, a2), this.a2 = rn.fromHueAndChroma(n6, a2 / 3), this.a3 = rn.fromHueAndChroma(n6 + 60, a2 / 2), this.n1 = rn.fromHueAndChroma(n6, Math.min(a2 / 12, 4)), this.n2 = rn.fromHueAndChroma(n6, Math.min(a2 / 6, 8))) : (this.a1 = rn.fromHueAndChroma(n6, Math.max(48, a2)), this.a2 = rn.fromHueAndChroma(n6, 16), this.a3 = rn.fromHueAndChroma(n6 + 60, 24), this.n1 = rn.fromHueAndChroma(n6, 4), this.n2 = rn.fromHueAndChroma(n6, 8)), this.error = rn.fromHueAndChroma(25, 84);
  }
}
function ri(e10) {
...
const _ru = class _ru {
  ...
  toDesignTokens() {
    ...
    for (let e11 in r10) if (a2[`${e11}`] = { _default: E(r10[e11]) ? rl(r10[e11]) : r10[e11], _dark: E(n6[e11]) ? rl(n6[e11]) : n6[e11] }, rc(e11) && (i2[`${e11}`] = tM.mixin({ bgColor: `sys.${e11}`, color: `sys.on-${e11}` }), i2[`${e11}-container`] = tM.mixin({ bgColor: `sys.${e11}-container`, color: `sys.on-${e11}-container` })), e11.startsWith("surface")) {
...
function rG(e10, t10, r10, n6, a2, i2, o2, s2, l2, c2, u2) {
  for (var d2 = a2 - 1, f2 = 0 === a2 ? i2 : [""], h2 = f2.length, p2 = 0, m2 = 0, g2 = 0; p2 < n6; ++p2) for (var y2 = 0, b2 = r$(e10, d2 + 1, d2 = rP(m2 = o2[p2])), v2 = e10; y2 < h2; ++y2) (v2 = (m2 > 0 ? f2[y2] + " " + b2 : rR(b2, /&\f/g, f2[y2])).trim()) && (l2[g2++] = v2);
  return rH(e10, t10, r10, 0 === a2 ? rk : s2, l2, c2, u2);
}
function rY(e10, t10, r10, n6) {
  return rH(e10, t10, r10, rC, r$(e10, 0, n6), r$(e10, n6 + 1, -1), n6);
}
function rX(e10, t10) {
...
var rJ = function(e10, t10, r10) {
  ...
  do
    switch (rN(n6)) {
      case 0:
        38 === n6 && 12 === rW() && (t10[r10] = 1), e10[r10] += rJ(rB - 1, t10, r10);
        break;
      case 2:
        e10[r10] += rU(n6);
        break;
    ...
    case rC:
      e10.return = function e11(t11, r11) {
        switch (45 ^ rD(t11, 0) ? (((r11 << 2 ^ rD(t11, 0)) << 2 ^ rD(t11, 1)) << 2 ^ rD(t11, 2)) << 2 ^ rD(t11, 3) : 0) {
          ...
          case 4968:
            return rR(rR(t11, /(.+:)(flex-)?(.*)/, rx + "box-pack:$3" + rb + "flex-pack:$3"), /s.+-b[^;]+/, "justify") + rx + t11 + t11;
          case 4095:
          case 3583:
          case 4068:
          case 2532:
      ...
      break;
    case rM:
      return rX([rz(e10, { value: rR(e10.value, "@", "@" + rx) })], n6);
    case rk:
      if (e10.length) {
        var a2, i2;
        return a2 = e10.props, i2 = function(t11) {
          ...
          switch (r11 = t11, (r11 = /(::plac\w+|:read-\w+)/.exec(r11)) ? r11[0] : r11) {
            case ":read-only":
            case ":read-write":
              return rX([rz(e10, { props: [rR(t11, /:(read-\w+)/, ":" + rv + "$1")] })], n6);
            case "::placeholder":
              return rX([rz(e10, { props: [rR(t11, /:(plac\w+)/, ":" + rx + "input-$1")] }), rz(e10, { props: [rR(t11, /:(plac\w+)/, ":" + rv + "$1")] }), rz(e10, { props: [rR(t11, /:(plac\w+)/, rb + "input-$1")] })], n6);
          }
          return "";
        }, a2.map(i2).join("");
      }
  ...
  var f2 = (r10 = (t10 = [r1, r2].concat(c2, [rK, (n6 = function(e11) {
    o2.insert(e11);
  }, function(e11) {
    ...
    return rX((r11 = function e12(t12, r12, n7, a3, i3, o3, s3, l3, c3) {
      for (var u3, d3 = 0, f3 = 0, h3 = s3, p3 = 0, m2 = 0, g2 = 0, y2 = 1, b2 = 1, v2 = 1, x2 = 0, w2 = "", k2 = i3, C2 = o3, M2 = a3, P2 = w2; b2; ) switch (g2 = x2, x2 = rj()) {
        case 40:
        ...
        case 47:
          switch (rW()) {
            ...
            case 47:
              ...
              }(rj(), rB), r12, n7, rw, r_(rV), r$(u3, 2, -2), 0), c3);
              break;
            default:
              P2 += "/";
          }
        ...
        case 0:
          switch (x2) {
            ...
            case 125:
              b2 = 0;
            case 59 + f3:
              -1 == v2 && (P2 = rR(P2, /\f/g, "")), m2 > 0 && rO(P2) - h3 && rI(m2 > 32 ? rY(P2 + ";", a3, n7, h3 - 1) : rY(rR(P2, " ", "") + ";", a3, n7, h3 - 2), c3);
              break;
            case 59:
              P2 += ";";
            default:
              if (rI(M2 = rG(P2, r12, n7, d3, f3, i3, l3, w2, k2 = [], C2 = [], h3), o3), 123 === x2) {
        ...
        default:
          if (y2 < 1) {
            if (123 == x2) --y2;
            else if (125 == x2 && 0 == y2++ && 125 == (rV = rB > 0 ? rD(rE, --rB) : 0, rL--, 10 === rV && (rL = 1, rA--), rV)) continue;
          }
...
let r6 = a(() => r5({ key: "css" }), { name: "Cache" }), r9 = (e10) => (t10) => {
  ...
  var n6;
  let { slots: a2, expose: s2 } = t10, l2 = rg.use(), c2 = r6.use(), u2 = l2.unstable_css(c2, null !== (n6 = e10.sx) && void 0 !== n6 ? n6 : {}), d2 = () => "0" !== u2.name ? `${c2.key}-${u2.name}` : "", f2 = r9(c2);
  i(() => {
...
function ne() {
  ...
  return null != e10 || (e10 = (e11, t10) => (n7) => {
    ...
    let n7 = Object.assign(t({ ...h2, sx: k().optional(), component: k().optional() }, (t10, a3) => {
      let o3 = rg.use(), s2 = r6.use(), l2 = r9(s2), h3 = c(""), p3 = o3.unstable_css(s2, r10), m2 = () => ("0" !== p3.name ? `${s2.key}-${p3.name}${h3.value}` : `${h3.value}`) + (n7.name ? ` ${n7.name}` : "");
      if (f2.__styled) {
        var g2;
...
let nt = t((e10) => {
  let { styles: t10 } = e10, r10 = rg.use(), n6 = r6.use(), a2 = r9(n6), i2 = r10.unstable_css(n6, T(t10) ? { "&": t10 } : t10);
  return u(() => {
...
let no = t((e10, t10) => {
  var n6;
  let { slots: a2, attrs: i2, emit: o2 } = t10, s2 = e10.contentRef || c(null), l2 = new ni(null !== (n6 = e10.triggerRef) && void 0 !== n6 ? n6 : c(null), s2, () => !!e10.isOpen), u2 = nn.use();
  return h(na.use().add(l2)), window && p(m(s2, "value"), b((e11) => {
    if (!e11) return;
    let t11 = (e12) => {
    ...
    var t11;
    let n7 = e10.isOpen ? d(r("div", { ...i2, ref: s2, style: e10.style, children: r(na, { value: l2, children: null === (t11 = a2.default) || void 0 === t11 ? void 0 : t11.call(a2) }) }), { onVnodeBeforeMount: () => {
...
function nC(e10, t10, r10) {
  let n6, { reference: a2, floating: i2 } = e10, o2 = nv(t10), s2 = ny(nv(t10)), l2 = nb(s2), c2 = nm(t10), u2 = "y" === o2, d2 = a2.x + a2.width / 2 - i2.width / 2, f2 = a2.y + a2.height / 2 - i2.height / 2, h2 = a2[l2] / 2 - i2[l2] / 2;
  switch (c2) {
    case "top":
...
let nM = async (e10, t10, r10) => {
  let { placement: n6 = "bottom", strategy: a2 = "absolute", middleware: i2 = [], platform: o2 } = r10, s2 = i2.filter(Boolean), l2 = await (null == o2.isRTL ? void 0 : o2.isRTL(t10)), c2 = await o2.getElementRects({ reference: e10, floating: t10, strategy: a2 }), { x: u2, y: d2 } = nC(c2, n6, l2), f2 = n6, h2 = {}, p2 = 0;
  for (let r11 = 0; r11 < s2.length; r11++) {
    let { name: i3, fn: m2 } = s2[r11], { x: g2, y: y2, data: b2, reset: v2 } = await m2({ x: u2, y: d2, initialPlacement: n6, placement: f2, strategy: a2, middlewareData: h2, rects: c2, platform: o2, elements: { reference: e10, floating: t10 } });
    u2 = null != g2 ? g2 : u2, d2 = null != y2 ? y2 : d2, h2 = { ...h2, [i3]: { ...h2[i3], ...b2 } }, v2 && p2 <= 50 && (p2++, "object" == typeof v2 && (v2.placement && (f2 = v2.placement), v2.rects && (c2 = true === v2.rects ? await o2.getElementRects({ reference: e10, floating: t10, strategy: a2 }) : v2.rects), { x: u2, y: d2 } = nC(c2, f2, l2)), r11 = -1);
  }
...
function nJ(e10, t10, r10) {
  ...
  if ("viewport" === t10) n6 = function(e11, t11) {
    ...
    let t11 = nT(e11), r11 = nH(e11), n7 = e11.ownerDocument.body, a2 = nl(t11.scrollWidth, t11.clientWidth, n7.scrollWidth, n7.clientWidth), i2 = nl(t11.scrollHeight, t11.clientHeight, n7.scrollHeight, n7.clientHeight), o2 = -r11.scrollLeft + nK(e11), s2 = -r11.scrollTop;
    ...
    let r11 = nX(e11, true, "fixed" === t11), n7 = r11.top + e11.clientTop, a2 = r11.left + e11.clientLeft, i2 = nO(e11) ? nU(e11) : nd(1), o2 = e11.clientWidth * i2.x;
...
function n0(e10, t10) {
  ...
  let n6 = nQ(e10, t10);
  for (; n6 && ["table", "td", "th"].includes(nS(n6)) && nZ(n6); ) n6 = nQ(n6, t10);
...
let n1 = async function(e10) {
  ...
  return { reference: function(e11, t11, r11) {
    let n7 = nO(t11), a2 = nT(t11), i2 = "fixed" === r11, o2 = nX(e11, true, i2, t11), s2 = { scrollLeft: 0, scrollTop: 0 }, l2 = nd(0);
    if (n7 || !n7 && !i2) {
      if (("body" !== nS(t11) || nA(a2)) && (s2 = nH(t11)), n7) {
  ...
  let { elements: t10, rect: r10, offsetParent: n6, strategy: a2 } = e10, i2 = "fixed" === a2, o2 = nT(n6), s2 = !!t10 && nL(t10.floating);
  if (n6 === o2 || s2 && i2) return r10;
  let l2 = { scrollLeft: 0, scrollTop: 0 }, c2 = nd(1), u2 = nd(0), d2 = nO(n6);
  if ((d2 || !d2 && !i2) && (("body" !== nS(n6) || nA(o2)) && (l2 = nH(n6)), nO(n6))) {
    let e11 = nX(n6);
  ...
  let { element: t10, boundary: r10, rootBoundary: n6, strategy: a2 } = e10, i2 = [..."clippingAncestors" === r10 ? nL(t10) ? [] : function(e11, t11) {
    let r11 = t11.get(e11);
    if (r11) return r11;
    let n7 = nj(e11, [], false).filter((e12) => n$(e12) && "body" !== nS(e12)), a3 = null, i3 = "fixed" === nE(e11).position, o3 = i3 ? nz(e11) : e11;
    for (; n$(o3) && !nV(o3); ) {
  ...
  return void 0 === e10 && (e10 = {}), { name: "size", options: e10, async fn(t10) {
    ...
    }, ...d2 } = np(e10, t10), f2 = await nP(t10, d2), h2 = nm(o2), p2 = ng(o2), m2 = "y" === nv(o2), { width: g2, height: y2 } = s2.floating;
    ...
    let b2 = y2 - f2.top - f2.bottom, v2 = g2 - f2.left - f2.right, x2 = ns(y2 - f2[a2], b2), w2 = ns(g2 - f2[i2], v2), k2 = !t10.middlewareData.shift, C2 = x2, M2 = w2;
    if (null != (r10 = t10.middlewareData.shift) && r10.enabled.x && (M2 = v2), null != (n6 = t10.middlewareData.shift) && n6.enabled.y && (C2 = b2), k2 && !p2) {
      let e11 = nl(f2.left, 0), t11 = nl(f2.right, 0), r11 = nl(f2.top, 0), n7 = nl(f2.bottom, 0);
      m2 ? M2 = g2 - 2 * (0 !== e11 || 0 !== t11 ? e11 + t11 : nl(f2.left, f2.right)) : C2 = y2 - 2 * (0 !== r11 || 0 !== n7 ? r11 + n7 : nl(f2.top, f2.bottom));
    }
    await u2({ ...t10, availableWidth: M2, availableHeight: C2 });
    let P2 = await l2.getDimensions(c2.floating);
    return g2 !== P2.width || y2 !== P2.height ? { reset: { rects: true } } : {};
  } };
}, n5 = (e10, t10, r10) => {
  let n6 = /* @__PURE__ */ new Map(), a2 = { platform: n2, ...r10 }, i2 = { ...a2.platform, _c: n6 };
  return nM(e10, t10, { ...a2, platform: i2 });
}, n3 = t((e10, t10) => {
  let { slots: n6, emit: a2, attrs: i2 } = t10, o2 = v(null), s2 = v(null);
  return p(W([o2, s2]), b((t11) => {
    let [r10, n7] = t11;
    if (n7 && r10) {
      let t12 = async () => {
        var t13, a4, i3, o3, s3;
        ...
        let { x: l2, y: c2 } = await n5(r10, n7, { placement: null !== (t13 = e10.placement) && void 0 !== t13 ? t13 : "bottom", middleware: [...null !== (a4 = e10.modifiers) && void 0 !== a4 ? a4 : [], ...null !== (i3 = e10.middleware) && void 0 !== i3 ? i3 : [], (void 0 === o3 && (o3 = {}), { name: "flip", options: o3, async fn(e11) {
          ...
          let x2 = nm(s4), w2 = nv(u2), k2 = nm(u2) === u2, C2 = await (null == d2.isRTL ? void 0 : d2.isRTL(f2.floating)), M2 = m2 || (k2 || !b2 ? [nw(u2)] : function(e12) {
            let t15 = nw(e12);
            return [nx(e12), t15, nx(t15)];
          }(u2)), P2 = "none" !== y2;
          !m2 && P2 && M2.push(...function(e12, t15, r12, n9) {
          ...
          if (h2 && R2.push(S2[x2]), p2) {
            let e12 = function(e13, t15, r12) {
              ...
              let n9 = ng(e13), a6 = ny(nv(e13)), i5 = nb(a6), o4 = "x" === a6 ? n9 === (r12 ? "end" : "start") ? "right" : "left" : "start" === n9 ? "bottom" : "top";
          ...
          let { x: t14, y: r11, placement: n8 } = e11, { mainAxis: a5 = true, crossAxis: i4 = false, limiter: o4 = { fn: (e12) => {
            let { x: t15, y: r12 } = e12;
            return { x: t15, y: r12 };
          } }, ...l3 } = np(s3, e11), c3 = { x: t14, y: r11 }, u2 = await nP(e11, l3), d2 = nv(nm(n8)), f2 = ny(d2), h2 = c3[f2], p2 = c3[d2];
          if (a5) {
      ...
      }, a3 = function(e11, t13, r11, n8) {
        let a4;
        void 0 === n8 && (n8 = {});
        let { ancestorScroll: i3 = true, ancestorResize: o3 = true, elementResize: s3 = "function" == typeof ResizeObserver, layoutShift: l2 = "function" == typeof IntersectionObserver, animationFrame: c2 = false } = n8, u2 = nq(e11), d2 = i3 || o3 ? [...u2 ? nj(u2) : [], ...nj(t13)] : [];
        d2.forEach((e12) => {
          i3 && e12.addEventListener("scroll", r11, { passive: true }), o3 && e12.addEventListener("resize", r11);
        });
        let f2 = u2 && l2 ? function(e12, t14) {
          let r12, n9 = null, a5 = nT(e12);
          function i4() {
            var e13;
          ...
          return function o4(s4, l3) {
            ...
            try {
              n9 = new IntersectionObserver(y2, { ...m3, root: a5.ownerDocument });
            } catch (e13) {
              n9 = new IntersectionObserver(y2, m3);
            }
            n9.observe(e12);
          }(true), i4;
        ...
        s3 && (p2 = new ResizeObserver((e12) => {
          let [n9] = e12;
          n9 && n9.target === u2 && p2 && (p2.unobserve(t13), cancelAnimationFrame(h2), h2 = requestAnimationFrame(() => {
            var e13;
        ...
        return c2 && function t14() {
          let n9 = nX(e11);
          m2 && (n9.x !== m2.x || n9.y !== m2.y || n9.width !== m2.width || n9.height !== m2.height) && r11(), m2 = n9, a4 = requestAnimationFrame(t14);
        }(), r11(), () => {
          var e12;
          d2.forEach((e13) => {
    ...
    } }), r(no, { triggerRef: o2, contentRef: s2, isOpen: e10.isOpen, onClickOutside: (e11) => a2("click-outside", e11), style: { zIndex: 100 }, $transition: n6.transition, children: null === (l2 = n6.content) || void 0 === l2 ? void 0 : l2.call(n6) })] }) : null;
  };

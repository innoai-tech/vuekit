...
function tD(t10) {
  return ti(t10) ? tU(t10, true) : function(t11) {
    if (!P(t11)) {
      var e10 = [];
      if (null != t11) for (var r10 in Object(t11)) e10.push(r10);
      return e10;
    }
    var n2 = ts(t11), o2 = [];
    for (var u2 in t11) "constructor" == u2 && (n2 || !tT.call(t11, u2)) || o2.push(u2);
    return o2;
  }(t10);
}
var tL = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, tM = /^\w*$/;
...
function eq(t10) {
  return function(e10) {
    ...
    return function(t11, e11, r11, n3) {
      ...
      return r11;
    }((n2 = ((r10 = t0(r10 = e10)) && r10.replace(eO, e_).replace(ex, "")).replace(eW, ""), (a2 = n2 = t0(n2), eA.test(a2)) ? n2.match(eG) || [] : n2.match(ew) || []), t10, "");
  };
}

...
import { i as isType, p as produce, c as custom, o as object } from "./lib-nodepkg-typedef.fsPa1Imn.chunk.js";
import { p as pipe, a as from, O as Observable, S as Subject, b as map, t as tap, B as BehaviorSubject, i as isObservable } from "./vendor-rxjs.Dpbcb-XH.chunk.js";
import { b as isFunction$2, p as partition, k as kebabCase, i as isPlainObject$1, a as isUndefined$1, d as isArray$2, f as isEmpty } from "./vendor-innoai-tech-lodash.D1Wq5XWs.chunk.js";
/**
* @vue/shared v3.5.13
...
function createBaseVNode(type) {
  let props = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, children = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, patchFlag = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0, dynamicProps = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null, shapeFlag = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : type === Fragment$1 ? 0 : 1, isBlockNode = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : false, needFullChildrenNormalization = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : false;
  const vnode = {
    __v_isVNode: true,
    __v_skip: true,
    type,
...
const isFragment = (val) => val === Fragment$1;

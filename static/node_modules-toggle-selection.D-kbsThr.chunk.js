import { t as e, c as t, v as a, w as l, P as o, i as n, B as r, j as s, m as c } from "./index.CxFCMZJ4.entry.js";
var i = function() {
...
let u = e(function(e2, t2) {
  ...
  try {
    ...
    try {
      ...
      o2 && console.error("unable to copy using clipboardData: ", r4), o2 && console.error("falling back to prompt"), a2 = "message" in t2 ? t2.message : "Copy to clipboard: #{key}, Enter", l2 = (/mac os x/i.test(navigator.userAgent) ? "⌘" : "Ctrl") + "+C", n2 = a2.replace(/#{\s*key\s*}/g, l2), window.prompt(n2, e2);
    }
  } finally {

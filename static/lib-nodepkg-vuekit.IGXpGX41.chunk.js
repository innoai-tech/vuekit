...
function nL(e10, r10) {
  ...
  if (tO(e10) ? (o10 = () => e10.value, y2 = /* @__PURE__ */ tg(e10)) : tv(e10) ? (o10 = () => g2(e10), y2 = true) : I(e10) ? (b2 = true, y2 = /* @__PURE__ */ e10.some((e11) => tv(e11) || tg(e11)), o10 = () => e10.map((e11) => tO(e11) ? e11.value : tv(e11) ? g2(e11) : M(e11) ? tU(e11, m2, 2) : void h2(e11))) : M(e10) ? o10 = r10 ? () => tU(e10, m2, 2) : () => (i10 && i10(), tz(e10, m2, 3, [_2])) : (o10 = $, h2(e10)), r10 && u2) {
    let e11 = o10;
    o10 = () => nN(/* @__PURE__ */ e11());
  }
  let _2 = (e11) => {
...
let ri = (e10) => e10 ? ob(e10) ? ok(e10) || e10.proxy : ri(e10.parent) : null, rl = (
  ...
  /* @__PURE__ */ P(/* @__PURE__ */ Object.create(null), { $: (e10) => e10, $el: (e10) => e10.vnode.el, $data: (e10) => e10.data, $props: (e10) => td(e10.props), $attrs: (e10) => td(e10.attrs), $slots: (e10) => td(e10.slots), $refs: (e10) => td(e10.refs), $parent: (e10) => ri(e10.parent), $root: (e10) => ri(e10.root), $emit: (e10) => e10.emit, $options: (e10) => rd(e10), $forceUpdate: (e10) => e10.f || (e10.f = () => {
  ...
  let h2 = rl[t10];
  return h2 ? ("$attrs" === t10 ? (eL(l10, "get", t10), nw = true) : "$slots" === t10 && eL(l10, "get", t10), h2(l10)) : (o10 = p2.__cssModules) && (o10 = o10[t10]) ? o10 : a10 !== S && T(a10, t10) ? (f2[t10] = 4, a10[t10]) : T(i10 = d2.config.globalProperties, t10) ? i10[t10] : void (ny && (!F(t10) || // #1091 avoid internal isRef/isVNode checks on component instance leading
...
let rL = (e10) => "_" === e10[0] || "$stable" === e10, rM = (e10) => I(e10) ? e10.map(oa) : [/* @__PURE__ */ oa(e10)], rF = (e10, t10, r10) => {
  ...
  if (32 & e10.vnode.shapeFlag) {
    let r10 = t10._;
    r10 ? (e10.slots = /* @__PURE__ */ tb(t10), er(t10, "_", r10)) : rN(t10, e10.slots = {});
  } else
...
function ow(e10, t10, r10) {
  M(t10) ? e10.type.__ssrInlineRender ? e10.ssrRender = t10 : e10.render = t10 : V(t10) ? (r9(t10) && tV("setup() should not return VNodes directly - return a render function instead."), e10.devtoolsRawSetupState = t10, e10.setupState = /* @__PURE__ */ tI(t10), function(e11) {
      ...
      !function(e11) {
        ...
        if (c2 && function(e12, t13) {
          ...
          for (let o12 in I(e12) && (e12 = /* @__PURE__ */ rg(e12)), e12) {
            let i11;
            let l11 = e12[o12];
            tO(i11 = V(l11) ? "default" in l11 ? /* @__PURE__ */ r$(l11.from || o12, l11.default, true) : /* @__PURE__ */ r$(l11.from || o12) : /* @__PURE__ */ r$(l11)) ? Object.defineProperty(t13, o12, { enumerable: true, configurable: true, get: () => i11.value, set: (e13) => i11.value = e13 }) : t13[o12] = i11, r12("Inject", o12);
          }
        }(c2, o11, L2), a10)
          for (let e12 in a10) {
            let t13 = a10[e12];
...
function ok(e10) {
  if (e10.exposed)
    return e10.exposeProxy || (e10.exposeProxy = new Proxy(tI(/* @__PURE__ */ t_(e10.exposed)), { get: (t10, r10) => r10 in t10 ? t10[r10] : r10 in rl ? rl[r10](e10) : void 0, has: (e11, t10) => t10 in e11 || t10 in rl }));
}
...
let oT = "3.4.19", oI = "undefined" != typeof document ? document : null, oR = oI && /* @__PURE__ */ oI.createElement("template"), oL = "transition", oM = "animation", oF = /* @__PURE__ */ Symbol("_vtc"), oN = (e10, t10) => {
  let { slots: r10 } = t10;
...
function oG(e10, t10, r10, o10) {
  ...
  let { type: a10, timeout: s2, propCount: u2 } = function(e11, t11) {
    let r11 = /* @__PURE__ */ window.getComputedStyle(e11), o11 = (e12) => (r11[e12] || "").split(", "), i11 = /* @__PURE__ */ o11(`${oL}Delay`), l11 = /* @__PURE__ */ o11(`${oL}Duration`), a11 = /* @__PURE__ */ oK(i11, l11), s3 = /* @__PURE__ */ o11(`${oM}Delay`), u3 = /* @__PURE__ */ o11(`${oM}Duration`), c3 = /* @__PURE__ */ oK(s3, u3), f3 = null, p3 = 0, d3 = 0;
    t11 === oL ? a11 > 0 && (f3 = oL, p3 = a11, d3 = l11.length) : t11 === oM ? c3 > 0 && (f3 = oM, p3 = c3, d3 = u3.length) : d3 = (f3 = (p3 = /* @__PURE__ */ Math.max(a11, c3)) > 0 ? a11 > c3 ? oL : oM : null) ? f3 === oL ? l11.length : u3.length : 0;
    let h2 = f3 === oL && /\b(transform|all)(,|$)/.test(/* @__PURE__ */ o11(`${oL}Property`).toString());
...
let oJ = /* @__PURE__ */ Symbol("_vod"), oQ = /* @__PURE__ */ Symbol("CSS_VAR_TEXT"), oX = /(^|;)\s*display\s*:/, oZ = /[^\\];\s*$/, o0 = /\s*!important$/;
...
e10.charCodeAt(2) > 96 && 123 > e10.charCodeAt(2), it = /* @__PURE__ */ P({ patchProp: (e10, t10, r10, o10, i10, l10, a10, s2, u2) => {
  ...
  "class" === t10 ? function(e11, t11, r11) {
    ...
    if (r11 && !i11) {
      ...
      if (t11 !== r11) {
        let e12 = o11[oQ];
        e12 && (r11 += ";" + e12), o11.cssText = r11, a11 = /* @__PURE__ */ oX.test(r11);
      }
    } else
...
For more details, see https://link.vuejs.org/feature-flags.`);
    ...
    let { insert: u2, remove: c2, patchProp: f2, createElement: p2, createText: d2, createComment: h2, setText: m2, setElementText: g2, parentNode: y2, nextSibling: b2, setScopeId: _2 = $, insertStaticContent: w2 } = e11, x2 = function(e12, t12, r12) {
      ...
      if (u3.type.__hmrId && function(e13) {
        ...
        (function(e14, t14, r14) {
          ...
          o12.compilerOptions && ox() && tV('"compilerOptions" is only supported when using a build of Vue that includes the runtime compiler. Since you are using a runtime-only build, the options should be passed via your build tool config instead.'), e14.accessCache = /* @__PURE__ */ Object.create(null), e14.proxy = /* @__PURE__ */ t_(new Proxy(e14.ctx, ru)), function(e15) {
          ...
          if (i14) {
            ...
            e$();
            let s2 = /* @__PURE__ */ tU(i14, e14, 0, [/* @__PURE__ */ td(e14.props), l13]);
            if (eO(), a12(), D(s2)) {
    ...
    return t11 && ([i11, l11] = /* @__PURE__ */ t11(em2)), { render: ev2, hydrate: i11, createApp: (r11 = i11, function(e12) {
      ...
      let o10 = /* @__PURE__ */ rw(), i12 = /* @__PURE__ */ new WeakSet(), l12 = false, a11 = o10.app = { _uid: rx++, _component: e12, _props: t12, _container: null, _context: o10, _instance: null, version: oT, get config() {
        return o10.config;
      }, set config(v) {
...
function lv(e10) {
  let t10 = /* @__PURE__ */ r$(lu), r10 = /* @__PURE__ */ r$(lc), o10 = /* @__PURE__ */ oA(() => t10.resolve(/* @__PURE__ */ tj(e10.to))), i10 = /* @__PURE__ */ oA(() => {
  ...
  return { route: o10, href: /* @__PURE__ */ oA(() => o10.value.href), isActive: l10, isExactActive: a10, navigate: function() {
    ...
    }(r11) ? Promise.resolve() : t10[tj(e10.replace) ? "replace" : "push"](/* @__PURE__ */ tj(e10.to)).catch(ih);
  } };
}
let lm = /* @__PURE__ */ nQ({ name: "RouterLink", compatConfig: { MODE: 3 }, props: {
  ...
  let { slots: r10 } = t10, o10 = /* @__PURE__ */ tc(/* @__PURE__ */ lv(e10)), { options: i10 } = r$(lu), l10 = /* @__PURE__ */ oA(() => ({
...
function lE(e10) {
  ...
  let u2 = /* @__PURE__ */ lp(), c2 = /* @__PURE__ */ lp(), f2 = /* @__PURE__ */ lp(), p2 = /* @__PURE__ */ tE(iL), d2 = iL;
...
${JSON.stringify(o11, null, 2)}
 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`), Promise.reject(Error("Infinite redirect in navigation guard"))) : x2(/* @__PURE__ */ ip({
  ...
  let I2 = (e11) => s2.go(e11), R2 = /* @__PURE__ */ new Set(), L2 = { currentRoute: p2, listening: true, addRoute: function(e11, t11) {
    ...
    e11.component("RouterLink", lm), e11.component("RouterView", lb), e11.config.globalProperties.$router = this, Object.defineProperty(e11.config.globalProperties, "$route", { enumerable: true, get: () => tj(p2) }), ic && // used for the initial navigation client side to avoid pushing
    ...
    e11.provide(lu, this), e11.provide(lc, /* @__PURE__ */ tf(l11)), e11.provide(lf, p2);
    let a11 = e11.unmount;
...
let sv = (e10) => "function" == typeof e10, sm = (e10) => void 0 === e10, sg = (e10) => e10 === r4, sy = (e10) => !!sg(e10) || "string" == typeof e10 || "object" == typeof e10 && !!e10.__isTeleport, sb = (e10) => !!e10 && "object" == typeof e10 && !!e10.__vInternal, s_ = (e10) => sv(e10) ? e10 : Array.isArray(e10) ? () => e10 : sm(e10) ? e10 : () => e10, sw = (e10, t10) => {
  ...
  for (let e11 in o10) {
    ...
    if (e11.startsWith("$")) {
      ...
      l10[r11] = /* @__PURE__ */ s_(t11), a10 = true;
      continue;
    }
    i10[e11] = t11;
  }
  let s2 = /* @__PURE__ */ s_(r10);
  return s2 && (l10.default = s2, a10 = true), [t10 ? { ...i10, key: t10 } : i10, a10 ? l10 : void 0];
}, sx = (e10, t10, r10) => sS(e10, t10, r10), sS = (e10, t10, r10) => {
  let [o10, i10] = sw(t10, r10);
  if (sy(e10)) {
    var l10, a10;
    return oj(e10, o10, null !== (a10 = null == i10 ? void 0 : null === (l10 = i10.default) || void 0 === l10 ? void 0 : l10.call(i10)) && void 0 !== a10 ? a10 : sg(e10) ? [] : void 0);
  }
...
function s$(e10) {
  return (t10) => {
    var r10;
    return /* @__PURE__ */ sS(sO, { elem$: /* @__PURE__ */ t10.pipe((r10 = (t11) => () => e10(t11), al(function(e11, t11) {
      var o10 = 0;
      e11.subscribe(/* @__PURE__ */ aa(t11, function(e12) {
...
let sO = /* @__PURE__ */ ii({ elem$: /* @__PURE__ */ g(), $default: /* @__PURE__ */ g() }, (e10, t10) => {
...
function sP(e10, t10) {
  ...
  return ii(l10, (e11, t11) => {
    let r11 = /* @__PURE__ */ sE(e11), o11 = new Proxy({}, { get(t12, o12) {
      var i11;
...
let sA = (e10) => {
  ...
  let r10 = null;
  return aR({ next: (o10) => {
    sj(o10, r10) || (null == t10 || t10(), t10 = /* @__PURE__ */ e10(o10), r10 = o10);
  }, unsubscribe: () => {
    null == t10 || t10();
  } });
};

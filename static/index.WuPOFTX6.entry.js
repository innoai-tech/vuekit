...
import { l as e, p as t, m as r, n as i, q as a, B as o, w as s, v as l, e as d, j as u, T as c, r as p, u as m, d as h, g as f, i as g, F as v, o as b, b as y, c as _, x, R as w, y as k, z as $, A as S, C } from "./lib-nodepkg-vuekit.ewYHbGH-.chunk.js";
...
import { b as Y, c as K, C as Z, e as J, f as Q, g as ee, h as et, i as en, j as er, r as ei, k as ea, B as eo, l as es, m as el, G as ed, n as eu, T as ec, d as ep, P as em } from "./lib-nodepkg-vueuikit.znd4NOHg.chunk.js";
import { D as eh, m as ef, a as eg, C as ev, b as eb } from "./webapp-vuekit-layout.yEdwzype.chunk.js";
(function() {
...
let eq = eO.create, eG = eT.create, eX = eI.create, eY = ez.create, eK = eV.create, eZ = ej.create, eJ = eP.create, eQ = eA.create, e0 = eM.create, e1 = eD.create, e2 = eD.nativeEnum, e4 = eD.literal, e5 = eL.create, e3 = eW.create, e8 = eB.create, e6 = eF.create, e9 = eH.create, e7 = eU.create, te = eU.discriminatorMapping, tt = ex.define, tn = ew.refine;
var tr, ti, ta, to = /* @__PURE__ */ Object.freeze({ __proto__: null, any: eG, array: e8, binary: e0, boolean: eQ, custom: tt, discriminatorMapping: te, enums: e1, integer: eJ, intersection: e9, literal: e4, nativeEnum: e2, never: eX, nil: eY, number: eZ, object: e5, pattern: function(e10, t10) {
...
function th(e10, r2, i2) {
  ...
  let f2 = /* @__PURE__ */ to.object(c2), g2 = () => f2.create({}), v2 = () => (void 0 === u2 && (u2 = /* @__PURE__ */ p2(/* @__PURE__ */ g2())), u2), b2 = /* @__PURE__ */ ts({ ...c2, $default: /* @__PURE__ */ to.custom().optional() }, (e11, r3) => {
    let { slots: i3 } = r3;
...
const _tk = class _tk {
  ...
  process(e10, t10, r2) {
    ...
    let d2 = t10;
    if (P(r2)) {
      e10[d2 = null !== (a2 = /* @__PURE__ */ _tk.convertSelector(d2)) && void 0 !== a2 ? a2 : d2] = null !== (o2 = e10[d2]) && void 0 !== o2 ? o2 : {}, this.processTo(e10[d2], r2);
      return;
    }
    if (l2 && tv[d2 = null !== (s2 = ty[d2]) && void 0 !== s2 ? s2 : d2]) {
      for (let t11 of tv[d2])
...
__publicField(_tk, "walkStateValues", function(e10, t10) {
  ...
  for (let e11 in a2) {
    ...
    if (P(s2)) {
      _tk.walkStateValues(s2, t10, { path: c2, selectorPath: u2, default: l2 });
      continue;
    }
    t10(s2, c2, u2);
  }
...
let tR = _tR;
let tO = (e10) => (t10) => `rgba(var(${t10}--rgb) / ${e10})`, tT = (e10) => z(e10) && B(e10, "token");
function tI(e10, t10) {
        ...
        for (let l2 of o2.tokens)
          if (!l2.includes("/")) {
            if (l2.startsWith("sys.")) {
              ...
              tC(t10, [a2, .../* @__PURE__ */ l2.split(".")], /* @__PURE__ */ i2(s3, e11)), e11 !== d2 && tC(r2, [a2, .../* @__PURE__ */ l2.split(".")], /* @__PURE__ */ i2(s3, d2));
            } else
...
const _tB = class _tB {
  ...
  getThemeRoleColors(e10) {
    ...
    for (let o2 in e10) {
      ...
      if (this.seeds[s2]) {
        var i2, a2;
        r2[o2] = tL[l2] ? `${s2}.${l2}` : null === (i2 = this.seeds[s2]) || void 0 === i2 ? void 0 : i2.tone(l2), t10[o2] = tL[d2] ? `${s2}.${d2}` : null === (a2 = this.seeds[s2]) || void 0 === a2 ? void 0 : a2.tone(d2);
      }
    }
    return [t10, r2];
  }
  toDesignTokens() {
    ...
    let o2 = (e11) => Object.keys(tL).reduce((t11, r3) => Object.assign(t11, { [r3]: /* @__PURE__ */ tN(/* @__PURE__ */ e11.tone(/* @__PURE__ */ parseInt(r3))) }), {}), s2 = /* @__PURE__ */ tS.color({ ...O(this.seeds, (e11) => o2(e11)), white: [255, 255, 255], black: [0, 0, 0], sys: i2 }), l2 = /* @__PURE__ */ tS.customMixin("containerStyle", { sys: a2 });
...
__publicField(_tB, "fromColors", (e10) => {
  ...
  return a2 && (d2.n1 = /* @__PURE__ */ Q.fromHueAndChroma(/* @__PURE__ */ J(a2), 4)), o2 && (d2.n2 = /* @__PURE__ */ Q.fromHueAndChroma(/* @__PURE__ */ J(o2), 8)), new _tB({ primary: d2.a1, secondary: d2.a2, tertiary: d2.a3, neutral: d2.n1, neutralVariant: d2.n2, error: d2.error, ...O(l2, (e11) => Q.fromInt(/* @__PURE__ */ J(e11))) });
});
let tB = _tB;
let tF = /* @__PURE__ */ tS.rounded({ xs: 4, sm: 8, md: 12, lg: 16, xl: 28 }), tH = { font: /* @__PURE__ */ tS.font({ brand: '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"', plain: '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"', code: "'Lucida Console',Consolas,Monaco,'Andale Mono','Ubuntu Mono',monospace" }), fontWeight: /* @__PURE__ */ tS.fontWeight({ regular: 400, medium: 500, bold: 700 }), textStyle: /* @__PURE__ */ tS.customMixin("textStyle", { sys: { "display-large": /* @__PURE__ */ tS.mixin({ lineHeight: 64, fontSize: 57, letterSpacing: -0.25, fontWeight: "regular", font: "brand" }), "display-medium": /* @__PURE__ */ tS.mixin({ lineHeight: 52, fontSize: 45, letterSpacing: 0, fontWeight: "regular", font: "brand" }), "display-small": /* @__PURE__ */ tS.mixin({ lineHeight: 44, fontSize: 36, letterSpacing: 0, fontWeight: "regular", font: "brand" }), "headline-large": /* @__PURE__ */ tS.mixin({ lineHeight: 40, fontSize: 32, letterSpacing: 0, fontWeight: "regular", font: "brand" }), "headline-medium": /* @__PURE__ */ tS.mixin({ lineHeight: 36, fontSize: 28, letterSpacing: 0, fontWeight: "regular", font: "brand" }), "headline-small": /* @__PURE__ */ tS.mixin({ lineHeight: 32, fontSize: 24, letterSpacing: 0, fontWeight: "regular", font: "plain" }), "title-large": /* @__PURE__ */ tS.mixin({ lineHeight: 28, fontSize: 22, letterSpacing: 0, fontWeight: "regular", font: "brand" }), "title-medium": /* @__PURE__ */ tS.mixin({ lineHeight: 24, fontSize: 16, letterSpacing: 0.15, fontWeight: "medium", font: "plain" }), "title-small": /* @__PURE__ */ tS.mixin({ lineHeight: 20, fontSize: 14, letterSpacing: 0.1, fontWeight: "medium", font: "plain" }), "label-large": /* @__PURE__ */ tS.mixin({ lineHeight: 20, fontSize: 14, letterSpacing: 0.1, fontWeight: "medium", font: "plain" }), "label-medium": /* @__PURE__ */ tS.mixin({ lineHeight: 16, fontSize: 12, letterSpacing: 0.5, fontWeight: "medium", font: "plain" }), "label-small": /* @__PURE__ */ tS.mixin({ lineHeight: 16, fontSize: 11, letterSpacing: 0.5, fontWeight: "medium", font: "plain" }), "body-large": /* @__PURE__ */ tS.mixin({ lineHeight: 24, fontSize: 16, letterSpacing: 0.5, fontWeight: "regular", font: "plain" }), "body-medium": /* @__PURE__ */ tS.mixin({ lineHeight: 20, fontSize: 14, letterSpacing: 0.25, fontWeight: "regular", font: "plain" }), "body-small": /* @__PURE__ */ tS.mixin({ lineHeight: 16, fontSize: 12, letterSpacing: 0.4, fontWeight: "regular", font: "plain" }) } }) }, tU = /* @__PURE__ */ tB.fromColors({ primary: "#1270f5", secondary: "#8a90a5", tertiary: "#b58391", neutral: "#5e5e5e", error: "#d93f23", warning: "#e69c00", success: "#5ac220" }), tq = { ...tH, ...tD, ...tj, rounded: tF, ...tU.toDesignTokens({ primary: ["primary", 80, 50] }) }, tG = /* @__PURE__ */ tV.create(tq, { varPrefix: "vk" }), tX = /* @__PURE__ */ th(() => tG, { name: "Theme" }), tY = /* @__PURE__ */ th(() => ee({ key: "css" }), { name: "Cache" }), tK = (e10) => (t10) => {
  ...
  var r2;
  let { slots: i2 } = t10, a2 = /* @__PURE__ */ tX.use(), o2 = /* @__PURE__ */ tY.use(), s2 = /* @__PURE__ */ a2.unstable_css(o2, null !== (r2 = e10.sx) && void 0 !== r2 ? r2 : {}), l2 = () => "0" !== s2.name ? `${o2.key}-${s2.name}` : "", d2 = /* @__PURE__ */ tK(o2);
  return b(() => {
...
function tQ(e10, t10, r2) {
  ...
  return (t11) => {
    let r3 = ts({ ...o2, sx: /* @__PURE__ */ to.custom().optional(), component: /* @__PURE__ */ to.custom().optional() }, (i3, o3) => {
      let s2 = /* @__PURE__ */ tX.use(), l2 = /* @__PURE__ */ tY.use(), d2 = /* @__PURE__ */ tK(l2);
      t11.label = r3.name;
...
ts(() => {
  ...
  return () => /* @__PURE__ */ u(t0, { styles: { ":host, :root, [data-theme]": t10, "*, *::after, *::before": { boxSizing: "border-box" }, html: { fontSize: "10px" }, a: { color: "inherit" }, body: { textStyle: "sys.body-medium" } } });
});
...
let t5 = /* @__PURE__ */ ts({ isOpen: /* @__PURE__ */ to.boolean().optional(), style: /* @__PURE__ */ to.custom().optional(), contentRef: /* @__PURE__ */ to.custom().optional(), triggerRef: /* @__PURE__ */ to.custom().optional(), onClickOutside: /* @__PURE__ */ to.custom(), onEscKeydown: /* @__PURE__ */ to.custom(), onContentBeforeMount: /* @__PURE__ */ to.custom(), $transition: /* @__PURE__ */ to.custom().optional(), $default: /* @__PURE__ */ to.custom().optional() }, (e10, t10) => {
  ...
  return d(/* @__PURE__ */ m2.add(l2)), window && td(/* @__PURE__ */ tc(s2, "value"), /* @__PURE__ */ tm((e11) => {
    if (!e11)
      return;
    let t11 = (e12) => {
    ...
    var t11;
    let r3 = e10.isOpen ? h(/* @__PURE__ */ u("div", { ...a2, ref: s2, style: e10.style, children: /* @__PURE__ */ u(t2, { value: l2, children: null === (t11 = i2.default) || void 0 === t11 ? void 0 : t11.call(i2) }) }), { onVnodeBeforeMount: () => {
  ...
  return s(() => l2.value, (t11) => {
    ...
    } }), /* @__PURE__ */ u(t5, { triggerRef: o2, contentRef: l2, isOpen: e10.isOpen, onClickOutside: (e11) => i2("click-outside", e11), style: { zIndex: 100 }, $transition: r2.transition, children: null === (s2 = r2.content) || void 0 === s2 ? void 0 : s2.call(r2) })] }) : null;
  };
}, { name: "Popper", inheritAttrs: false }), t8 = /* @__PURE__ */ tQ("button", { hover: /* @__PURE__ */ to.boolean().optional(), focus: /* @__PURE__ */ to.boolean().optional(), active: /* @__PURE__ */ to.boolean().optional(), disabled: /* @__PURE__ */ to.boolean().optional() })({ textStyle: "sys.label-large", display: "inline-flex", alignItems: "center", justifyContent: "center", textDecoration: "none", outline: "none", overflow: "hidden", border: 0, margin: 0, userSelect: "none", cursor: "pointer", _disabled: { cursor: "not-allowed" }, gap: 8, h: 40, px: 24, rounded: 20, transitionDuration: "md4", transitionTimingFunction: "standard-accelerate", bg: "none", pos: "relative", zIndex: 1, _$before: { content: '""', pos: "absolute", top: 0, right: 0, left: 0, bottom: 0, zIndex: -1, transitionDuration: "md1", transitionTimingFunction: "standard-accelerate" }, $data_icon: { boxSize: 18, _data_placement__start: { ml: -8 }, _data_placement__end: { mr: -8 } } }), t6 = /* @__PURE__ */ tQ(t8)({ containerStyle: "sys.primary", shadow: "1", _hover: { shadow: "2", _$before: { bgColor: /* @__PURE__ */ tI("white", /* @__PURE__ */ tO(0.08)) } }, _focus: { shadow: "2", _$before: { bgColor: /* @__PURE__ */ tI("white", /* @__PURE__ */ tO(0.12)) } }, _active: { shadow: "2", _$before: { bgColor: /* @__PURE__ */ tI("white", /* @__PURE__ */ tO(0.12)) } }, _disabled: { shadow: "0", color: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.38)), bgColor: "rgba(0,0,0,0)", _$before: { bgColor: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.12)) } } }), t9 = /* @__PURE__ */ tQ(t8)({ color: "sys.primary", shadow: "1", _$before: { bgColor: "sys.surface-container-low" }, _hover: { shadow: "2", _$before: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.08)) } }, _focus: { shadow: "2", _$before: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.12)) } }, _active: { shadow: "2", _$before: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.12)) } }, _disabled: { shadow: "0", color: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.38)), _$before: { bgColor: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.12)) } } }), t7 = /* @__PURE__ */ tQ(t8)({ extends: [{ px: 16, $data_icon: { _data_placement__start: { ml: -4 }, _data_placement__end: { mr: -4 } } }], color: "sys.primary", _$before: { bgColor: "rgba(0,0,0,0)" }, _hover: { _$before: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.08)) } }, _focus: { _$before: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.12)) } }, _active: { _$before: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.12)) } }, _disabled: { color: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.38)), bgColor: "rgba(0,0,0,0)", _$before: { bgColor: "rgba(0,0,0,0)" } } }), ne = /* @__PURE__ */ tQ(t8)({ containerStyle: "sys.secondary-container", color: "sys.primary", shadow: "0", _hover: { shadow: "1", _$before: { bgColor: /* @__PURE__ */ tI("sys.on-secondary-container", /* @__PURE__ */ tO(0.08)) } }, _focus: { _$before: { bgColor: /* @__PURE__ */ tI("sys.on-secondary-container", /* @__PURE__ */ tO(0.12)) } }, _active: { _$before: { bgColor: /* @__PURE__ */ tI("sys.on-secondary-container", /* @__PURE__ */ tO(0.12)) } }, _disabled: { color: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.38)), bgColor: "rgba(0,0,0,0)", shadow: "0", _$before: { bgColor: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.12)) } } }), nt = /* @__PURE__ */ tQ(t8)({ extends: [{
  // ensure the order to define border before all
  border: "1px solid"
}], color: "sys.primary", bgColor: "rgba(0,0,0,0)", borderColor: "sys.outline", _hover: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.08)) }, _active: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.12)) }, _focus: { bgColor: /* @__PURE__ */ tI("sys.primary", /* @__PURE__ */ tO(0.12)) }, _disabled: { color: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.38)), bgColor: "rgba(0,0,0,0)", borderColor: /* @__PURE__ */ tI("sys.on-surface", /* @__PURE__ */ tO(0.12)) } }), nn = /* @__PURE__ */ tQ(t7, {})({ boxSize: 40, p: 0 }), nr = /* @__PURE__ */ tQ("span", { placement: /* @__PURE__ */ to.enums(["start", "end"]).optional(), path: /* @__PURE__ */ to.string() }, (e10, t10) => (t11) => /* @__PURE__ */ u(t11, { "data-icon": true, "data-placement": e10.placement, children: /* @__PURE__ */ u("svg", { viewBox: "0 0 24 24", children: /* @__PURE__ */ u("path", { d: e10.path }) }) }))({ boxSize: "1.2em" }), ni = /* @__PURE__ */ tM({ from: { opacity: 0 }, to: { opacity: 1 }, duration: tA.duration.md1, easing: tA.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: tA.duration.sm4, easing: tA.easing.standard.decelerate }), na = /* @__PURE__ */ tQ("div")({ py: 4, px: 12, rounded: "sm", shadow: "3", containerStyle: "sys.on-surface", pos: "relative", zIndex: 100 }), no = /* @__PURE__ */ ts({ title: /* @__PURE__ */ to.custom(), $default: /* @__PURE__ */ to.custom() }, (e10, t10) => {
  let { slots: r2 } = t10, i2 = /* @__PURE__ */ p(false);
  return () => {
    let t11 = r2.default()[0];
    return /* @__PURE__ */ u(t3, { isOpen: i2.value, $content: /* @__PURE__ */ u(na, { children: e10.title }), $transition: (e11) => {
      let { content: t12 } = e11;
      return u(ni, { children: t12 });
  ...
  return () => {
    ...
    return /* @__PURE__ */ u(t3, { isOpen: i2.value, placement: e10.placement, onClickOutside: () => {
      i2.value = false;
    }, $content: /* @__PURE__ */ u(ns, { children: null === (t11 = r2.menu) || void 0 === t11 ? void 0 : t11.call(r2) }), children: a2 ? h(a2, { onClick: () => {
      i2.value = true;
    } }) : null });
  };
}), nu = /* @__PURE__ */ tQ("div")({ pos: "absolute", top: 0, left: 0, h: "100vh", w: "100vw", zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center" }), nc = /* @__PURE__ */ tQ("div")({ cursor: "pointer", pos: "absolute", top: 0, left: 0, h: "100vh", w: "100vw", zIndex: -1, bgColor: /* @__PURE__ */ tI("sys.scrim", /* @__PURE__ */ tO(0.38)) }), np = /* @__PURE__ */ tQ("div")({ py: 12, rounded: "sm", shadow: "3", minW: "50vw", containerStyle: "sys.surface-container-high" }), nm = /* @__PURE__ */ tM({ from: { opacity: 0 }, to: { opacity: 1 }, duration: tA.duration.md1, easing: tA.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: tA.duration.sm4, easing: tA.easing.standard.accelerate }), nh = /* @__PURE__ */ ts({ isOpen: t5.propTypes.isOpen, onClose: /* @__PURE__ */ to.custom(), $default: /* @__PURE__ */ to.custom().optional() }, (e10, t10) => {
  var r2;
  ...
  return s(() => e10.isOpen, (e11) => {
    ...
    var e11;
    return /* @__PURE__ */ u(t5, { isOpen: o2.value, onContentBeforeMount: () => {
      l2.value = true;
    }, onEscKeydown: () => {
      l2.value = false;
    }, children: /* @__PURE__ */ g(nu, { children: [/* @__PURE__ */ u(nm, { onComplete: (e12) => {
      "leave" === e12 && (o2.value = false, a2("close"));
    }, children: l2.value ? /* @__PURE__ */ u(nc, { onClick: () => {
      l2.value = false;
  ...
  return () => /* @__PURE__ */ u(eo, { sx: { py: 16, px: 0, textTransform: "capitalize" }, children: /* @__PURE__ */ X(t10, (e11, t11) => {
    ...
    return /* @__PURE__ */ g(eo, { sx: { px: 8 }, children: [i2[0] ? /* @__PURE__ */ u(t7, { component: k, sx: { width: "100%", justifyContent: "flex-start" }, activeClass: "active", to: null === (r2 = i2[0]) || void 0 === r2 ? void 0 : r2.path, children: t11 }) : /* @__PURE__ */ u(t7, { sx: { width: "100%", justifyContent: "flex-start" }, children: t11 }), /* @__PURE__ */ u(eo, { sx: { pl: 16 }, children: /* @__PURE__ */ X(a2, (e12) => {
      var t12;
      return /* @__PURE__ */ u(t7, { component: k, activeClass: "active", to: e12.path, sx: { width: "100%", justifyContent: "flex-start" }, children: null === (t12 = /* @__PURE__ */ N(/* @__PURE__ */ e12.path.split("/"))) || void 0 === t12 ? void 0 : t12.replaceAll("-", " ") }, e12.name);
    }) })] }, t11);
  }) });
  ...
  return () => {
    var e11;
    return /* @__PURE__ */ g(eo, { "data-theme": i2.value, sx: { display: "flex", height: "100vh", width: "100vw", containerStyle: "sys.surface" }, children: [/* @__PURE__ */ g(eo, { sx: { display: "flex", flexDirection: "column", width: "280px", height: "100vh", borderRightRadius: "lg", overflowY: "auto", containerStyle: "sys.surface-container-low", elevation: "0", _hover: { elevation: "2" } }, children: [/* @__PURE__ */ u(eo, { sx: { flex: 1 }, children: /* @__PURE__ */ u(n_, {}) }), /* @__PURE__ */ g(eo, { sx: { p: 16, display: "flex", justifyContent: "flex-end" }, children: [/* @__PURE__ */ u(nn, { component: "a", target: "_blank", sx: { color: "sys.on-surface-variant" }, href: "//github.com/innoai-tech/vuekit", children: /* @__PURE__ */ u(nr, { path: eb }) }), /* @__PURE__ */ u(no, { title: `切换到${"light" === i2.value ? "深色模式" : "浅色模式"}`, children: /* @__PURE__ */ u(eo, { component: nn, "data-test": true, sx: { color: "sys.on-surface-variant" }, onClick: () => {
      i2.value = "light" === i2.value ? "dark" : "light";
    }, children: /* @__PURE__ */ u(nr, { path: "light" === i2.value ? ef : eg }) }) })] })] }), /* @__PURE__ */ u(eo, { sx: { flex: 1, overflow: "auto" }, children: /* @__PURE__ */ u(ev, { children: null === (e11 = r2.default) || void 0 === e11 ? void 0 : e11.call(r2) }) })] });
  };
}), ny = /* @__PURE__ */ _(() => {
...
}, nS = /* @__PURE__ */ _(() => () => /* @__PURE__ */ u(eo, { sx: { display: "flex", alignItems: "center", justifyContent: "center", textStyle: "sys.display-large" }, children: "Vuekit" })), nC = /* @__PURE__ */ Object.assign(nS, { displayName: "IndexDefault" }), nE = [{ name: "vuematerial", path: "/vuematerial", component: () => n$(() => import("./nodepkg-vuematerial-example.udjVs5X1.chunk.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), props: true }, { name: "vuematerial-icons", path: "/vuematerial/icons", component: () => n$(() => import("./nodepkg-vuematerial-example.VT9E86Sk.chunk.js"), true ? __vite__mapDeps([4,1,2,3,5,6]) : void 0), props: true }, { name: "vuematerial-textfields", path: "/vuematerial/textfields", component: () => n$(() => import("./nodepkg-vuematerial-example.hKvIJOhO.chunk.js"), true ? __vite__mapDeps([7,1,2,3,6,5]) : void 0), props: true }, { name: "vuematerial-buttons", path: "/vuematerial/buttons", component: () => n$(() => import("./nodepkg-vuematerial-example.F0QR14cI.chunk.js"), true ? __vite__mapDeps([8,1,2,3,6,5]) : void 0), props: true }, { name: "vuematerial-overlays", path: "/vuematerial/overlays", component: () => n$(() => import("./nodepkg-vuematerial-example.Kgy8Bok_.chunk.js"), true ? __vite__mapDeps([9,1,2,3,6,5]) : void 0), props: true }, { name: "vueuikit-typography", path: "/vueuikit/typography", component: () => n$(() => import("./nodepkg-vueuikit-example.YkDhU8X8.chunk.js"), true ? __vite__mapDeps([10,1,2,3,6]) : void 0), props: true }, { name: "vueuikit", path: "/vueuikit", component: () => n$(() => import("./nodepkg-vueuikit-example.BuadXDH7.chunk.js"), true ? __vite__mapDeps([11,1,2,3,6]) : void 0), props: true }, { name: "vueuikit-color-scheme", path: "/vueuikit/color-scheme", component: () => n$(() => import("./nodepkg-vueuikit-example.t6d4Rqln.chunk.js"), true ? __vite__mapDeps([12,1,2,3,6]) : void 0), props: true }, { name: "vueuikit-popper", path: "/vueuikit/popper", component: () => n$(() => import("./nodepkg-vueuikit-example.l4wcMUGX.chunk.js"), true ? __vite__mapDeps([13,1,2,3,6]) : void 0), props: true }, { name: "vueuikit-elevation", path: "/vueuikit/elevation", component: () => n$(() => import("./nodepkg-vueuikit-example.h1J2V0po.chunk.js"), true ? __vite__mapDeps([14,1,2,3,6]) : void 0), props: true }, { name: "vueuikit-figma-tokens", path: "/vueuikit/figma-tokens", component: () => n$(() => import("./nodepkg-vueuikit-example.wwxOhmtD.chunk.js"), true ? __vite__mapDeps([15,2,1,3,6]) : void 0), props: true }, { name: "vueuikit-color-palette", path: "/vueuikit/color-palette", component: () => n$(() => import("./node_modules-toggle-selection.THmSHKkn.chunk.js"), true ? __vite__mapDeps([16,1,2,3,6,5]) : void 0), props: true }, { name: "vuekit", path: "/vuekit", component: () => n$(() => import("./nodepkg-vuekit-example.u7JS7RuK.chunk.js"), true ? __vite__mapDeps([17,1,2,3]) : void 0), props: true }, { name: "vuekit-rx-in-vue", path: "/vuekit/rx-in-vue", component: () => n$(() => import("./nodepkg-vuekit-example.Y4HBoR5b.chunk.js"), true ? __vite__mapDeps([18,1,2,3]) : void 0), props: true }, { name: "index", path: "/", component: /* @__PURE__ */ Object.assign(nC, { meta: { name: "Home", icon: () => n$(() => import("./webapp-vuekit-layout.yEdwzype.chunk.js").then((e10) => e10.i), true ? __vite__mapDeps([5,6,2,1,3]) : void 0) } }), props: true }];
console.log(nE);
let nR = new URL(null !== (ta = null === (ti = /* @__PURE__ */ document.querySelector("base")) || void 0 === ti ? void 0 : ti.href) && void 0 !== ta ? ta : "/"), nO = /* @__PURE__ */ $({ history: /* @__PURE__ */ S(nR.pathname), routes: nE });
C(nw).use(nO).mount("#root");
export {
  nh as D,
  t9 as E,
  t6 as F,
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["static/nodepkg-vuematerial-example.udjVs5X1.chunk.js","static/lib-nodepkg-vuekit.ewYHbGH-.chunk.js","static/vendor-core-js.CpeR9-zu.chunk.js","static/lib-nodepkg-typedef.E0gBujd-.chunk.js","static/nodepkg-vuematerial-example.VT9E86Sk.chunk.js","static/webapp-vuekit-layout.yEdwzype.chunk.js","static/lib-nodepkg-vueuikit.znd4NOHg.chunk.js","static/nodepkg-vuematerial-example.hKvIJOhO.chunk.js","static/nodepkg-vuematerial-example.F0QR14cI.chunk.js","static/nodepkg-vuematerial-example.Kgy8Bok_.chunk.js","static/nodepkg-vueuikit-example.YkDhU8X8.chunk.js","static/nodepkg-vueuikit-example.BuadXDH7.chunk.js","static/nodepkg-vueuikit-example.t6d4Rqln.chunk.js","static/nodepkg-vueuikit-example.l4wcMUGX.chunk.js","static/nodepkg-vueuikit-example.h1J2V0po.chunk.js","static/nodepkg-vueuikit-example.wwxOhmtD.chunk.js","static/node_modules-toggle-selection.THmSHKkn.chunk.js","static/nodepkg-vuekit-example.u7JS7RuK.chunk.js","static/nodepkg-vuekit-example.Y4HBoR5b.chunk.js"]
  }

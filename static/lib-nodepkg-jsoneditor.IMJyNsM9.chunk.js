...
}, { displayName: "Actions" })({ display: "flex" }), et = /* @__PURE__ */ B(U, { displayName: "ActionBtn" })({ transition: "none", width: 24, height: 24, rounded: 12, [`& ${V}`]: { svg: { width: 18, height: 18 } } }), en = /* @__PURE__ */ B("span", { displayName: "Token" })({ textStyle: "sys.label-small", fontWeight: "bold", fontFamily: "inherit", fontSize: 12, lineHeight: 24, wordBreak: "keep-all", whiteSpace: "nowrap", font: "code", opacity: 0.3 }), el = /* @__PURE__ */ l((e2, t2) => {
  let { slots: l2 } = t2;
  return () => {
    var t3;
...
}, { displayName: "Line", props: ["path", "dirty", "viewOnly", "title", "description"] }), eu = /* @__PURE__ */ B("div", { displayName: "Lines" })({}), eh = /* @__PURE__ */ B("section", { displayName: "LineSection" })({}), ey = /* @__PURE__ */ B("div", { displayName: "LinesTrailing" })({}), ev = /* @__PURE__ */ B("div", { displayName: "LineRow" })({ display: "flex", alignItems: "start", pr: 10 }), em = /* @__PURE__ */ B("span", { displayName: "Description" })({ display: "block" });
class ef extends t {
  static from(e2) {
    let t2 = new ef(false);
    return s(e2, /* @__PURE__ */ w((e3) => e3 ? C(/* @__PURE__ */ s(/* @__PURE__ */ N(e3, "focus"), /* @__PURE__ */ k(() => {
      t2.show();
    })), /* @__PURE__ */ s(/* @__PURE__ */ N(e3, "blur"), /* @__PURE__ */ $(10), /* @__PURE__ */ k(() => {
      t2.hide();
    }))) : S), /* @__PURE__ */ p()), t2;
  }
  show() {
...
let e$ = /* @__PURE__ */ c(function(e2, t2) {
    ...
    if (r2 = /* @__PURE__ */ eC(), o2 = /* @__PURE__ */ document.createRange(), d2 = /* @__PURE__ */ document.getSelection(), (s2 = /* @__PURE__ */ document.createElement("span")).textContent = e2, s2.ariaHidden = "true", s2.style.all = "unset", s2.style.position = "fixed", s2.style.top = 0, s2.style.clip = "rect(0, 0, 0, 0)", s2.style.whiteSpace = "pre", s2.style.webkitUserSelect = "text", s2.style.MozUserSelect = "text", s2.style.msUserSelect = "text", s2.style.userSelect = "text", s2.addEventListener("copy", function(n3) {
      if (n3.stopPropagation(), t2.format) {
        if (n3.preventDefault(), void 0 === n3.clipboardData) {
          ...
          var l3 = eN[t2.format] || eN.default;
  ...
  let {} = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "复制当前节点为 JSON 字符串", children: /* @__PURE__ */ n(et, { type: "button", onClick: () => e$(/* @__PURE__ */ JSON.stringify(e2.value, null, 2)), children: /* @__PURE__ */ n(V, { path: F }) }) });
}, { displayName: "CopyAsJSONIconBtn", props: ["value"] });
class eT extends O {
  static from(e2) {
    let t2 = new eT("");
    return s(e2, /* @__PURE__ */ w((e3) => e3 ? s(/* @__PURE__ */ N(e3, "input"), /* @__PURE__ */ k((e4) => {
...
class eI extends T {
  static from(e2) {
    let t2 = new eI();
    return s(e2, /* @__PURE__ */ w((e3) => e3 ? C(/* @__PURE__ */ s(/* @__PURE__ */ N(e3, "keypress"), /* @__PURE__ */ k((e4) => {
      "Enter" !== e4.key || e4.shiftKey || (e4.preventDefault(), t2.next({ type: "COMMIT" }));
    })), /* @__PURE__ */ s(/* @__PURE__ */ N(e3, "keydown"), /* @__PURE__ */ k((e4) => {
      switch (e4.key) {
        case "Tab":
    ...
    })), /* @__PURE__ */ s(/* @__PURE__ */ N(e3, "keyup"), /* @__PURE__ */ k((e4) => {
...
class eA extends g {
  ...
  static sync(e2, t2) {
    return s(/* @__PURE__ */ C(/* @__PURE__ */ s(e2, /* @__PURE__ */ k((e3) => {
...
let eD = /* @__PURE__ */ e(() => new eA()), eL = /* @__PURE__ */ l((e2, l2) => {
  let a2, { render: i2 } = l2, o2 = /* @__PURE__ */ h(null), d2 = /* @__PURE__ */ h(null), c2 = /* @__PURE__ */ h(null), u2 = /* @__PURE__ */ eI.from(c2), v2 = /* @__PURE__ */ eD.use(), m2 = /* @__PURE__ */ ef.from(c2), f2 = /* @__PURE__ */ Q.use();
  ...
  return (s(u2, /* @__PURE__ */ k((e3) => {
  ...
  }), /* @__PURE__ */ p()), s(/* @__PURE__ */ C(/* @__PURE__ */ s(d2, /* @__PURE__ */ y((e3) => {
    if (e3) {
    ...
    if (e3) {
      ...
      return n2(e3), C(/* @__PURE__ */ s(/* @__PURE__ */ N(e3, "blur"), /* @__PURE__ */ k((t3) => {
        if (t3.relatedTarget) {
          var n3, l3;
      ...
      })), /* @__PURE__ */ s(/* @__PURE__ */ N(e3, "input"), /* @__PURE__ */ k((e4) => {
        n2(e4.target);
      })));
    }
    return S;
  }))), /* @__PURE__ */ p()), "enums" == e2.typedef.type) ? s(/* @__PURE__ */ E([e2.value$, m2, g2]), /* @__PURE__ */ i2((t2) => {
    var l3, a3, i3;
    let [r2, s2, { index: p2 }] = t2, u3 = null !== (l3 = /* @__PURE__ */ x.schemaProp(e2.typedef, "enum")) && void 0 !== l3 ? l3 : [], h2 = null !== (a3 = /* @__PURE__ */ x.metaProp(e2.typedef, "enumLabels")) && void 0 !== a3 ? a3 : [];
    return /* @__PURE__ */ n(eR, { ref: d2, onClick: () => {
      m2.show();
    }, "data-type": typeof r2, tabindex: 0, children: s2 ? /* @__PURE__ */ n(eb, { onSelected: (e3) => {
      T2(e3);
    }, open$: m2, $content: /* @__PURE__ */ n("div", { ref: o2, children: /* @__PURE__ */ u3.map((e3, t3) => /* @__PURE__ */ n(e_, { "data-focus": p2 % u3.length === t3, value: e3, label: h2[t3] })) }), children: /* @__PURE__ */ n("input", { value: void 0 == r2 ? "" : `${r2}`, ref: c2, "data-options": true }) }) : /* @__PURE__ */ n("span", { children: null !== (i3 = /* @__PURE__ */ JSON.stringify(r2)) && void 0 !== i3 ? i3 : "undefined" }) });
  ...
  return s(e2.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(ep, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(ee, { children: /* @__PURE__ */ n(eO, { value: t3 }) }), $trailing: /* @__PURE__ */ n(ej, { ctx: e2.ctx, onAdd: (t4) => {
    ...
    return /* @__PURE__ */ r(ec, { path: c2, dirty: /* @__PURE__ */ a2.isDirty(s2, c2), title: /* @__PURE__ */ x.metaProp(p2, "title"), description: /* @__PURE__ */ x.metaProp(p2, "description"), children: [/* @__PURE__ */ n(el, { deprecated: /* @__PURE__ */ x.schemaProp(p2, "deprecated"), $leading: /* @__PURE__ */ n(eB, { onRemove: () => {
      a2.delete(c2);
    } }), children: /* @__PURE__ */ String(d2) }), /* @__PURE__ */ r(en, { children: [":", " "] }), null === (o2 = i2.$value) || void 0 === o2 ? void 0 : o2.call(i2, p2, s2, { ...e2.ctx, path: c2, branch: [...e2.ctx.branch, s2] })] });
  }) })));
}, { displayName: "ObjectInput", props: ["typedef", "ctx", "value"] }), ej = /* @__PURE__ */ l((e2, l2) => {
  let { emit: a2, render: i2 } = l2, o2 = /* @__PURE__ */ h(null), d2 = /* @__PURE__ */ eI.from(o2), c2 = /* @__PURE__ */ eT.from(o2), u2 = /* @__PURE__ */ ef.from(o2), y2 = /* @__PURE__ */ Q.use(), v2 = new t({ index: 0 }), m2 = () => {
    u2.hide(), c2.next(""), o2.value && (o2.value.value = "", o2.value.blur()), v2.next({ index: 0 });
  };
  s(c2, /* @__PURE__ */ k((t2) => {
  ...
  return s(e2.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(ep, { openToken: "[", closeToken: "]", $leading: /* @__PURE__ */ n(ee, { children: /* @__PURE__ */ n(eO, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eU, { ctx: e2.ctx, typedef: e2.typedef, onAdd: (t4) => {
    ...
    return /* @__PURE__ */ r(ec, { path: p2, dirty: /* @__PURE__ */ a2.isDirty(d2, p2), children: [/* @__PURE__ */ n(el, { $leading: /* @__PURE__ */ n(eV, { onRemove: () => {
      a2.delete(p2);
    } }), children: /* @__PURE__ */ n(W, { sx: { opacity: 0.3, mr: "0.5em" }, children: /* @__PURE__ */ String(o2) }) }), null === (l3 = i2.$value) || void 0 === l3 ? void 0 : l3.call(i2, s2, d2, { ...e2.ctx, path: p2, branch: [...e2.ctx.branch, d2] })] });
  }) })));
}, { displayName: "ArrayInput", props: ["ctx", "value", "typedef"] }), eU = /* @__PURE__ */ l((e2, t2) => {
  let { emit: l2, render: a2 } = t2, i2 = /* @__PURE__ */ h(null), o2 = /* @__PURE__ */ eT.from(i2), d2 = /* @__PURE__ */ eI.from(i2), c2 = /* @__PURE__ */ ef.from(i2), u2 = /* @__PURE__ */ Q.use(), y2 = () => {
  ...
  return s(e2.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(ep, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(ee, { children: /* @__PURE__ */ n(eO, { value: t3 }) }), $trailing: /* @__PURE__ */ n(ej, { ctx: e2.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, d2)) return null;
    let c2 = [...e2.ctx.path, d2];
    return /* @__PURE__ */ r(ec, { path: c2, dirty: /* @__PURE__ */ a2.isDirty(s2, c2), children: [/* @__PURE__ */ n(el, { $leading: /* @__PURE__ */ n(eB, { onRemove: () => {
      a2.delete(c2);
    } }), children: /* @__PURE__ */ String(d2) }), /* @__PURE__ */ r(en, { children: [":", " "] }), null === (o2 = i2.$value) || void 0 === o2 ? void 0 : o2.call(i2, p2, s2, { ...e2.ctx, path: c2, branch: [...e2.ctx.branch, s2] })] });
  }) })));
  ...
  return s(a2, /* @__PURE__ */ l2((e3) => {
    ...
    return /* @__PURE__ */ n(eD, { children: /* @__PURE__ */ n(Y, { value: { $value: null !== (l3 = i2.$value) && void 0 !== l3 ? l3 : eK }, children: /* @__PURE__ */ r(eq, { children: [/* @__PURE__ */ n("section", { ref: o2 }), o2.value && /* @__PURE__ */ n(es, { value: { indent: 0, $container: o2 }, children: /* @__PURE__ */ n(ec, { path: [], viewOnly: true, children: /* @__PURE__ */ d2(a2.typedef, e3, b) }) })] }) }) });
  }));

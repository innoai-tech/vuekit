...
export const elem = defineExpression("elem", <TTarget extends any[]>(buildExprFn: ExpressionBuildFunc<TTarget, any>) => (ctx: any) => {
...
export const key = defineExpression("key", <TTarget extends any[]>(buildExprFn: ExpressionBuildFunc<TTarget, any>) => (ctx: any) => {

import { component$, EmptyContext, JSONPointer, rx, type Type } from "@innoai-tech/vuekit";
import { JSONEditorProvider, JSONEditorSlotsProvider, type ValueContext } from "./models";
...
export const defaultValueRender = (typedef: Type, value: any, ctx: ValueContext) => {
  return <ValueInput typedef={typedef} value={value} ctx={ctx} />;
};

export const JSONEditorView = component$<{ readOnly?: boolean }>((props, { render }) => {
        ...
        <OneEditingProvider>
          ...
          >
            <JSONEditorContainer>
              <Lines>
                {[
                  ...flattenValue(root, editor$.initialsAt([]), editor$.typedef, {
                    ...EmptyContext,
...
const Lines = styled<{ $default: VNodeChild }, "div">("div", (_, { slots }) => {
  return (Wrap) => {

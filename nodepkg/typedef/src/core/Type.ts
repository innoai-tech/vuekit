...
export class Type<T = unknown, Schema = unknown> {
    ...
    * entries(
    ...
    use<S extends Type<T, Schema>, A>(op1: UnaryFunction<S, A>): A;
    use<S extends Type<T, Schema>, A, B>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>): B;
    use<S extends Type<T, Schema>, A, B, C>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>): C;
    use<S extends Type<T, Schema>, A, B, C, D>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>, op4: UnaryFunction<C, D>): D;
    use<S extends Type<T, Schema>, A, B, C, D, E>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>, op4: UnaryFunction<C, D>, op5: UnaryFunction<D, E>): E;
    use<S extends Type<T, Schema>, A, B, C, D, E, F>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>, op4: UnaryFunction<C, D>, op5: UnaryFunction<D, E>, op6: UnaryFunction<E, F>): F;
    use<S extends Type<T, Schema>, A, B, C, D, E, F, G>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>, op4: UnaryFunction<C, D>, op5: UnaryFunction<D, E>, op6: UnaryFunction<E, F>, op7: UnaryFunction<F, G>): G;
    use<S extends Type<T, Schema>, A, B, C, D, E, F, G, H>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>, op4: UnaryFunction<C, D>, op5: UnaryFunction<D, E>, op6: UnaryFunction<E, F>, op7: UnaryFunction<F, G>, op8: UnaryFunction<G, H>): H;
    use<S extends Type<T, Schema>, A, B, C, D, E, F, G, H, I>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>, op4: UnaryFunction<C, D>, op5: UnaryFunction<D, E>, op6: UnaryFunction<E, F>, op7: UnaryFunction<F, G>, op8: UnaryFunction<G, H>, op9: UnaryFunction<H, I>): I;
    use<S extends Type<T, Schema>, A, B, C, D, E, F, G, H, I>(op1: UnaryFunction<S, A>, op2: UnaryFunction<A, B>, op3: UnaryFunction<B, C>, op4: UnaryFunction<C, D>, op5: UnaryFunction<D, E>, op6: UnaryFunction<E, F>, op7: UnaryFunction<F, G>, op8: UnaryFunction<G, H>, op9: UnaryFunction<H, I>, ...operations: UnaryFunction<T, Schema>[]): Type<unknown, unknown>;
